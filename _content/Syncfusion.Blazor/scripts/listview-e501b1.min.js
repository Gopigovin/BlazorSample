(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["listview"],{
...
var sflistview = function sflistview(exports) {
  ...
  function (_super) {
    ...
    ListView.prototype.findItemFromDS = function (dataSource, fields, parent) {
      ...
      if (dataSource && dataSource.length && fields) {
        dataSource.some(function (data) {
          ...
          } else if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(data) !== 'object' && dataSource.indexOf(data) !== -1) {
            resultJSON = parent ? dataSource : data;
    ...
    ListView.prototype.findParent = function (dataSource, id, callback, parent) {
      ...
      for (var i = 0; i < Object.keys(dataSource).length; i++) {
        if (dataSource[Object.keys(dataSource)[i]] && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(dataSource[Object.keys(dataSource)[i]]) === 'object') {
          // tslint:disable-next-line:no-any
  ...
  function () {
    ...
    Virtualization.prototype.createAndInjectNewItem = function (itemData, index) {
      ...
      var target;
      var li = sf.lists.ListBase.createListItemFromJson(this.listViewInstance.createElement, [itemData], this.listViewInstance.listBaseOption); // check for target element whether to insert before last item or group item
...
sfBlazor.modules["listview"] = "lists.ListView";
sfBlazor.loadDependencies(sfBlazor.dependencyJson.listview, function () {
