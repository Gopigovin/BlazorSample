(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["inplaceeditor"],{
...
var sfinplaceeditor = function sfinplaceeditor(exports) {
  ...
  function getCompValue(type, val) {
    ...
    if ((type === 'Date' || type === 'Time' || type === 'DateTime') && typeof val === 'string') {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(val) === 'object' && typeof val[0] === 'string') {
  ...
  function (_super) {
    ...
    InPlaceEditor.prototype.getInitFieldMapValue = function () {
      ...
      if (model.dataSource instanceof sf.data.DataManager) {
        ...
        this.updateInitValue(mText, mVal, new sf.data.DataManager(model.dataSource).executeLocal(this.getInitQuery(model, query)));
      }
    };
    ...
    InPlaceEditor.prototype.getInitQuery = function (model, query) {
      ...
      if (this.type !== 'MultiSelect' || _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(this.value) !== 'object') {
    ...
    InPlaceEditor.prototype.renderValue = function (val) {
      this.enableHtmlSanitizer && this.type !== 'RTE' && this.type !== 'MultiSelect' ? this.valueEle.innerText = val : this.valueEle.innerHTML = val;
    ...
    InPlaceEditor.prototype.updateValue = function () {
      ...
      if (!sf.base.isNullOrUndefined(this.value)) {
        this.setProperties({
          value: getCompValue(this.type, value)
        }, true);
    ...
    InPlaceEditor.prototype.destroyButtons = function () {
      ...
      if (!sf.base.isNullOrUndefined(this.cancelBtn)) {
        sf.base.EventHandler.remove(this.cancelBtn.element, 'mousedown', this.cancelHandler);
        ...
        this.formValidate = new sf.inputs.FormValidator(this.formEle, {
          ...
          validationComplete: function validationComplete(e) {
            ...
            _this.trigger('validating', args, function (validateArgs) {
              ...
              if (!sf.base.isNullOrUndefined(fromSubmit) && fromSubmit) {
                fromSubmit = false;
    ...
    InPlaceEditor.prototype.wireBtnEvents = function () {
      ...
      if (!sf.base.isNullOrUndefined(this.cancelBtn)) {
        sf.base.EventHandler.add(this.cancelBtn.element, 'mousedown', this.cancelHandler, this);
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.inplaceeditor, function () {
