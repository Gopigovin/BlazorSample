(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["treegrid"],{
...
var sftreegrid = function sftreegrid(exports) {
  'use strict';
  /**
  ...
  function (_super) {
    ...
    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "field", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "operator", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "value", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "matchCase", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "ignoreAccent", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "predicate", void 0);

    __decorate$1([sf.base.Property({})], Predicate$$1.prototype, "actualFilterValue", void 0);

    __decorate$1([sf.base.Property({})], Predicate$$1.prototype, "actualOperator", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "type", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "ejpredicate", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "uid", void 0);

    __decorate$1([sf.base.Property()], Predicate$$1.prototype, "isForeignKey", void 0);
  ...
  function (_super) {
    ...
    __decorate$1([sf.base.Collection([], Predicate$1)], FilterSettings.prototype, "columns", void 0);

    __decorate$1([sf.base.Property('FilterBar')], FilterSettings.prototype, "type", void 0);

    __decorate$1([sf.base.Property()], FilterSettings.prototype, "mode", void 0);

    __decorate$1([sf.base.Property(true)], FilterSettings.prototype, "showFilterBarStatus", void 0);

    __decorate$1([sf.base.Property(1500)], FilterSettings.prototype, "immediateModeDelay", void 0);

    __decorate$1([sf.base.Property()], FilterSettings.prototype, "operators", void 0);

    __decorate$1([sf.base.Property(false)], FilterSettings.prototype, "ignoreAccent", void 0);

    __decorate$1([sf.base.Property('Parent')], FilterSettings.prototype, "hierarchyMode", void 0);
  ...
  function (_super) {
    ...
    __decorate$2([sf.base.Property('Both')], TextWrapSettings.prototype, "wrapMode", void 0);
      ...
      if (!sf.base.isNullOrUndefined(currentRecords[selectedIndex][parentItem])) {
        ...
        for (var i = 0; i < treeLevel + 1; i++) {
          for (var j = 0; j < currentRecords.length; j++) {
            if (!sf.base.isNullOrUndefined(currentRecords[selectedIndex][parentItem]) && currentRecords[j][uniqueID] === currentRecords[selectedIndex][parentItem][uniqueID]) {
              selectedIndex = j;
  ...
  function isRemoteData(parent) {
    if (parent.dataSource instanceof sf.data.DataManager) {
      ...
      return adaptor instanceof sf.data.ODataAdaptor || adaptor instanceof sf.data.WebApiAdaptor || adaptor instanceof sf.data.WebMethodAdaptor || adaptor instanceof sf.data.CacheAdaptor || adaptor instanceof sf.data.UrlAdaptor;
    }
  ...
  function getExpandStatus(parent, record, parents) {
    var parentRecord = sf.base.isNullOrUndefined(record.parentItem) ? null : getParentData(parent, record.parentItem.uniqueID);
    var childParent;

    if (parentRecord != null) {
      if (parent.initialRender && !sf.base.isNullOrUndefined(parentRecord[parent.expandStateMapping]) && !parentRecord[parent.expandStateMapping]) {
        ...
        if (childParent && parent.initialRender && !sf.base.isNullOrUndefined(childParent[parent.expandStateMapping]) && !childParent[parent.expandStateMapping]) {
  ...
  function findChildrenRecords(records) {
    ...
    if (sf.base.isNullOrUndefined(records) || !records.hasChildRecords && !sf.base.isNullOrUndefined(records.childRecords) && !records.childRecords.length) {
      return [];
    }
    ...
    if (!sf.base.isNullOrUndefined(records.childRecords)) {
      ...
      for (var i = 0, len = Object.keys(childRecords).length; i < len; i++) {
        ...
        if (childRecords[i].hasChildRecords || !sf.base.isNullOrUndefined(childRecords[i].childRecords) && childRecords[i].childRecords.length) {
  ...
  function () {
    ...
    Selection.prototype.headerCheckbox = function () {
      ...
      if (this.columnIndex > -1 && this.parent.getHeaderContent().querySelectorAll('.e-treeselectall').length === 0) {
        ...
        checkWrap = sf.buttons.createCheckBox(this.parent.createElement, false, {
          checked: value,
          label: ' '
        });
    ...
    Selection.prototype.selectCheckboxes = function (rowIndexes) {
      ...
      for (var i = 0; i < rowIndexes.length; i++) {
        ...
        record = sf.base.isBlazor() && this.parent.dataSource[adaptorName] === 'BlazorAdaptor' ? record : flatRecord;
    ...
    Selection.prototype.traverSelection = function (record, checkboxState, ischildItem) {
      ...
      if (record.childRecords && this.parent.autoCheckHierarchy) {
        ...
        if (!sf.base.isNullOrUndefined(this.parent.filterModule) && this.parent.filterModule.filteredResult.length > 0 && this.parent.autoCheckHierarchy) {
    ...
    Selection.prototype.updateParentSelection = function (parentRecord) {
      ...
      if (!sf.base.isNullOrUndefined(record)) {
        var _loop_1 = function _loop_1(i) {
          ...
          var checkBoxRecord = sf.base.isBlazor() && this_1.parent.dataSource[adaptorName] === 'BlazorAdaptor' ? childRecord[0] : currentRecord;
    ...
    Selection.prototype.headerSelection = function (checkAll) {
      ...
      var index = -1;
      var length = 0;
      var data = !sf.base.isNullOrUndefined(this.parent.filterModule) && this.parent.filterModule.filteredResult.length > 0 ? this.parent.filterModule.filteredResult : this.parent.flatData;
      data = sf.base.isBlazor() && this.parent.dataSource[adaptorName] === 'BlazorAdaptor' || isRemoteData(this.parent) ? this.parent.getCurrentViewRecords() : data;
    ...
    Selection.prototype.updateSelectedItems = function (currentRecord, checkState, filter) {
      ...
      checkedRecord = sf.base.isBlazor() && this.parent.dataSource[adaptorName] === 'BlazorAdaptor' ? record[0] : checkboxRecord;
      ...
      if (checkState === 'check' && sf.base.isNullOrUndefined(currentRecord.isSummaryRow)) {
        ...
        if (this.selectedItems.indexOf(checkedRecord) === -1 && recordIndex !== -1 && !sf.base.isNullOrUndefined(this.parent.filterModule) && this.parent.filterModule.filteredResult.length > 0) {
          this.selectedItems.push(checkedRecord);
        }

        if (this.selectedItems.indexOf(checkedRecord) === -1 && !sf.base.isNullOrUndefined(this.parent.filterModule) && this.parent.filterModule.filteredResult.length === 0) {
          this.selectedItems.push(checkedRecord);
        }
      ...
      if (isCheckboxcolumn(this.parent)) {
        if (this.parent.autoCheckHierarchy) {
          if (requestType === 'sorting' || requestType === 'paging') {
            ...
            this.selectedItems = [];
            this.selectedIndexes = [];
            childData = !sf.base.isNullOrUndefined(this.parent.filterModule) && this.parent.filterModule.filteredResult.length > 0 ? this.parent.getCurrentViewRecords() : this.parent.flatData;
  ...
  function (_super) {
    ...
    __decorate$3([sf.base.Property()], SearchSettings.prototype, "fields", void 0);

    __decorate$3([sf.base.Property(false)], SearchSettings.prototype, "ignoreCase", void 0);

    __decorate$3([sf.base.Property('contains')], SearchSettings.prototype, "operator", void 0);

    __decorate$3([sf.base.Property()], SearchSettings.prototype, "key", void 0);

    __decorate$3([sf.base.Property()], SearchSettings.prototype, "hierarchyMode", void 0);
  ...
  function (_super) {
    ...
    __decorate$4([sf.base.Property('Row')], SelectionSettings.prototype, "mode", void 0);

    __decorate$4([sf.base.Property('Flow')], SelectionSettings.prototype, "cellSelectionMode", void 0);

    __decorate$4([sf.base.Property('Single')], SelectionSettings.prototype, "type", void 0);

    __decorate$4([sf.base.Property(false)], SelectionSettings.prototype, "persistSelection", void 0);

    __decorate$4([sf.base.Property('Default')], SelectionSettings.prototype, "checkboxMode", void 0);

    __decorate$4([sf.base.Property(false)], SelectionSettings.prototype, "checkboxOnly", void 0);

    __decorate$4([sf.base.Property(true)], SelectionSettings.prototype, "enableToggle", void 0);
  ...
  function () {
    ...
    Render.prototype.RowModifier = function (args) {
      ...
      if (!sf.base.isNullOrUndefined(data.parentItem) && !isFilterChildHierarchy(this.parent) && (!(this.parent.allowPaging && !(this.parent.pageSettings.pageSizeMode === 'Root')) || isRemoteData(this.parent) && !isOffline(this.parent))) {
        index = data.parentItem.index;
        var collapsed$$1 = this.parent.initialRender && (!(sf.base.isNullOrUndefined(parentData[this.parent.expandStateMapping]) || parentData[this.parent.expandStateMapping]) || this.parent.enableCollapseAll) || !getExpandStatus(this.parent, args.data, this.parent.grid.getCurrentViewRecords());
    ...
    Render.prototype.cellRender = function (args) {
      ...
      if (grid.getColumnIndexByUid(args.column.uid) === this.parent.treeColumnIndex && (args.requestType === 'add' || args.requestType === 'delete' || sf.base.isNullOrUndefined(args.cell.querySelector('.e-treecell')))) {
        ...
        var iconRequired = !sf.base.isNullOrUndefined(data.hasFilteredChildRecords) ? data.hasFilteredChildRecords : data.hasChildRecords;
        ...
        if (iconRequired) {
          ...
          var expandIcon = sf.base.createElement('span', {
            className: 'e-icons'
          });
          var expand = void 0;

          if (this.parent.initialRender) {
            expand = data.expanded && (sf.base.isNullOrUndefined(data[this.parent.expandStateMapping]) || data[this.parent.expandStateMapping]) && !this.parent.enableCollapseAll;
          } else {
          ...
          if (!sf.base.isNullOrUndefined(data.parentItem) && !sf.base.isNullOrUndefined(data[this.parent.expandStateMapping]) && data[this.parent.expandStateMapping] && !(this.parent.allowPaging && !(this.parent.pageSettings.pageSizeMode === 'Root'))) {
        ...
        cellElement = sf.base.createElement('span', {
      ...
      if (this.parent.frozenColumns > this.parent.treeColumnIndex && grid.getColumnIndexByUid(args.column.uid) === this.parent.frozenColumns + 1) {
        sf.base.addClass([args.cell], 'e-gridrowindex' + index + 'level' + data.level);
      } else if (this.parent.frozenColumns <= this.parent.treeColumnIndex && grid.getColumnIndexByUid(args.column.uid) === this.parent.frozenColumns - 1) {
        sf.base.addClass([args.cell], 'e-gridrowindex' + index + 'level' + data.level);
      }
      ...
      if (summaryRow) {
        ...
        args.cell.querySelector('.e-treecell') != null ? args.cell.querySelector('.e-treecell').innerHTML = summaryData : args.cell.innerHTML = summaryData;
      }
    ...
    Render.prototype.updateTreeCell = function (args, cellElement, container) {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(args.column.template) === 'object' && this.templateResult) {
  ...
  function () {
    ...
    DataManipulation.prototype.convertToFlatData = function (data) {
      ...
      this.parent.flatData = Object.keys(data).length === 0 && !(this.parent.dataSource instanceof sf.data.DataManager) ? this.parent.dataSource : [];
      ...
      if (isRemoteData(this.parent) && !isOffline(this.parent) && data instanceof sf.data.DataManager && !(data instanceof Array)) {
        ...
        if (this.parent.parentIdMapping) {
          this.parent.query = sf.base.isNullOrUndefined(this.parent.query) ? new sf.data.Query() : this.parent.query;
    ...
    DataManipulation.prototype.convertJSONData = function (data) {
      ...
      if (this.isSelfReference) {
        var selfData = [];
        var mappingData = new sf.data.DataManager(this.hierarchyData).executeLocal(new sf.data.Query().group(this.parent.parentIdMapping));
    ...
    DataManipulation.prototype.updateParentRemoteData = function (args) {
      ...
      if (!this.parent.hasChildMapping && !this.parentItems.length && !(this.parent.dataSource[adaptorName] === 'BlazorAdaptor' && !this.parent[clientRender]) && !this.parent.loadChildOnDemand) {
      ...
      args.result = this.parent.dataSource[adaptorName] === 'BlazorAdaptor' && !this.parent[clientRender] && !sf.base.isNullOrUndefined(records) || this.parent.loadChildOnDemand ? this.parent.flatData : records;
    ...
    DataManipulation.prototype.collectExpandingRecs = function (rowDetails, isChild) {
      ...
      if (rowDetails.rows.length > 0) {
        ...
        for (var i = 0; i < rowDetails.rows.length; i++) {
          ...
          if (sf.base.isBlazor() && this.parent.dataSource[adaptorName] === 'BlazorAdaptor' && !this.parent[clientRender] || this.parent.loadChildOnDemand) {
    ...
    DataManipulation.prototype.fetchRemoteChildData = function (rowDetails, isChild) {
      ...
      dm.executeQuery(qry).then(function (e) {
        ...
        for (var r = 0; r < result.length; r++) {
          ...
          sf.base.setValue('uniqueIDCollection.' + result[r].uniqueID, result[r], _this.parent); // delete result[r].parentItem.childRecords;
    ...
    DataManipulation.prototype.createRecords = function (data, parentRecords) {
      ...
      for (var i = 0, len = Object.keys(data).length; i < len; i++) {
        ...
        if (!sf.base.isNullOrUndefined(currentData[this.parent.childMapping]) || currentData[this.parent.hasChildMapping] && isCountRequired(this.parent)) {
          currentData.hasChildRecords = true;

          if (this.parent.enableCollapseAll || !sf.base.isNullOrUndefined(this.parent.dataStateChange) && sf.base.isNullOrUndefined(currentData[this.parent.childMapping])) {
            currentData.expanded = false;
          } else {
            currentData.expanded = !sf.base.isNullOrUndefined(currentData[this.parent.expandStateMapping]) ? currentData[this.parent.expandStateMapping] : true;
          }
        }
    ...
    DataManipulation.prototype.dataProcessor = function (args) {
      ...
      if (!sf.base.isNullOrUndefined(actionAddArgs) && !sf.base.isNullOrUndefined(actionAddArgs.action) && actionAddArgs.action === 'add' && !sf.base.isNullOrUndefined(actionAddArgs.data) && sf.base.isNullOrUndefined(actionAddArgs.data[primaryKeyColumnName])) {
      ...
      if (!sf.base.isNullOrUndefined(actionArgs) && Object.keys(actionArgs).length || requestType === 'save') {
        ...
        if (action === 'add' || requestType === 'batchsave' && this.parent.editSettings.mode === 'Batch' && this.batchChanges[this.addedRecords].length) {
      ...
      if (isExport && !sf.base.isNullOrUndefined(expresults)) {
        ...
        dataObj = isCountRequired(this.parent) ? sf.base.getValue('result', this.parent.grid.dataSource) : this.parent.grid.dataSource;
      }

      var results = dataObj instanceof sf.data.DataManager ? dataObj.dataSource.json : dataObj;
      var count = isCountRequired(this.parent) ? sf.base.getValue('count', this.parent.dataSource) : results.length;
      ...
      if (this.parent.grid.sortSettings.columns.length > 0 || this.isSortAction) {
        ...
        for (var srt = this.parent.grid.sortSettings.columns.length - 1; srt >= 0; srt--) {
          ...
          var compFun = col.sortComparer && !this.isRemote() ? col.sortComparer.bind(col) : this.parent.grid.sortSettings.columns[srt].direction;
      ...
      count = isCountRequired(this.parent) ? sf.base.getValue('count', this.parent.dataSource) : results.length;
    ...
    DataManipulation.prototype.paging = function (results, count, isExport, isPrinting, exportType, args) {
      if (this.parent.allowPaging && (!isExport || exportType === 'CurrentPage') && (!isPrinting || this.parent.printMode === 'CurrentPage')) {
        this.parent.notify(pagingActions, {
          result: results,
          count: count
        });
        results = this.dataResults.result;
        count = isCountRequired(this.parent) ? sf.base.getValue('count', this.parent.dataSource) : this.dataResults.count;
      } else if (this.parent.enableVirtualization && (!isExport || exportType === 'CurrentPage') && sf.base.getValue('requestType', args) !== 'save') {
        this.parent.notify(pagingActions, {
          result: results,
          count: count,
          actionArgs: sf.base.getValue('actionArgs', args)
        });
        results = this.dataResults.result;
  ...
  function (_super) {
    ...
    __decorate$5([sf.base.Property(12)], PageSettings.prototype, "pageSize", void 0);

    __decorate$5([sf.base.Property(8)], PageSettings.prototype, "pageCount", void 0);

    __decorate$5([sf.base.Property(1)], PageSettings.prototype, "currentPage", void 0);

    __decorate$5([sf.base.Property()], PageSettings.prototype, "totalRecordsCount", void 0);

    __decorate$5([sf.base.Property(false)], PageSettings.prototype, "enableQueryString", void 0);

    __decorate$5([sf.base.Property(false)], PageSettings.prototype, "pageSizes", void 0);

    __decorate$5([sf.base.Property(null)], PageSettings.prototype, "template", void 0);

    __decorate$5([sf.base.Property('All')], PageSettings.prototype, "pageSizeMode", void 0);
  ...
  function (_super) {
    ...
    AggregateColumn.prototype.setTemplate = function (helper) {
      ...
      if (this.footerTemplate !== undefined) {
        this.templateFn[sf.base.getEnumValue(sf.grids.CellType, sf.grids.CellType.Summary)] = {
          fn: sf.base.compile(this.footerTemplate, helper),
    ...
    __decorate$6([sf.base.Property()], AggregateColumn.prototype, "type", void 0);

    __decorate$6([sf.base.Property()], AggregateColumn.prototype, "footerTemplate", void 0);

    __decorate$6([sf.base.Property()], AggregateColumn.prototype, "field", void 0);

    __decorate$6([sf.base.Property()], AggregateColumn.prototype, "format", void 0);

    __decorate$6([sf.base.Property()], AggregateColumn.prototype, "columnName", void 0);

    __decorate$6([sf.base.Property()], AggregateColumn.prototype, "customAggregate", void 0);
  ...
  function (_super) {
    ...
    __decorate$6([sf.base.Collection([], AggregateColumn)], AggregateRow.prototype, "columns", void 0);

    __decorate$6([sf.base.Property(true)], AggregateRow.prototype, "showChildSummary", void 0);
  ...
  function (_super) {
    ...
    __decorate$7([sf.base.Property(false)], EditSettings.prototype, "allowAdding", void 0);

    __decorate$7([sf.base.Property(false)], EditSettings.prototype, "allowEditing", void 0);

    __decorate$7([sf.base.Property(false)], EditSettings.prototype, "allowDeleting", void 0);

    __decorate$7([sf.base.Property('Cell')], EditSettings.prototype, "mode", void 0);

    __decorate$7([sf.base.Property('Top')], EditSettings.prototype, "newRowPosition", void 0);

    __decorate$7([sf.base.Property(true)], EditSettings.prototype, "allowEditOnDblClick", void 0);

    __decorate$7([sf.base.Property(true)], EditSettings.prototype, "showConfirmDialog", void 0);

    __decorate$7([sf.base.Property(false)], EditSettings.prototype, "showDeleteConfirmDialog", void 0);

    __decorate$7([sf.base.Property('')], EditSettings.prototype, "template", void 0);

    __decorate$7([sf.base.Property({})], EditSettings.prototype, "dialog", void 0);
  ...
  function (_super) {
    ...
    __decorate$8([sf.base.Property()], SortDescriptor.prototype, "field", void 0);

    __decorate$8([sf.base.Property()], SortDescriptor.prototype, "direction", void 0);
  ...
  function (_super) {
    ...
    __decorate$8([sf.base.Collection([], SortDescriptor)], SortSettings.prototype, "columns", void 0);

    __decorate$8([sf.base.Property(true)], SortSettings.prototype, "allowUnsort", void 0);
  ...
  function (_super) {
    ...
    TreeGrid.prototype.initProperties = function () {
      ...
      this.isLocalData = !(this.dataSource instanceof sf.data.DataManager) || this.dataSource.dataSource.offline || !sf.base.isNullOrUndefined(this.dataSource.ready) || this.dataSource.adaptor instanceof sf.data.RemoteSaveAdaptor;
    ...
    TreeGrid.prototype.render = function () {
      ...
      if (!sf.base.isBlazor() || !this.isServerRendered) {
        ...
        this.addListener();
        var gridContainer = sf.base.createElement('div', {
      ...
      var destroyTemplateFn = this.grid[destroyTemplate]; //tslint:disable-next-line:no-any
      ...
      if (sf.base.isBlazor() && this.isServerRendered) {
        var fn_1 = function fn_1(args) {
          return _this.gridRendered(args, fn_1);
        };
    ...
    TreeGrid.prototype.bindGridEvents = function () {
      ...
      this.grid.rowSelected = function (args) {
        if (!sf.base.isBlazor()) {
          ...
          _this.setProperties({
            selectedRowIndex: _this.grid.selectedRowIndex
          }, true);
    ...
    TreeGrid.prototype.extendedGridDataBoundEvent = function () {
      ...
      this.grid.beforeDataBound = function (args) {
        ...
        if (!isRemoteData(treeGrid) && !isCountRequired(this) && !sf.base.isNullOrUndefined(treeGrid.dataSource)) {
          ...
          treeGrid.notify('dataProcessor', args); //args = this.dataModule.dataProcessor(args);
        }

        sf.base.extend(args, treeGrid.dataResults); // this.notify(events.beforeDataBound, args);
      ...
      this.grid.dataStateChange = function (args) {
        if (_this.isExpandRefresh) {
          ...
          _this.grid.dataSource = {
            ...
            count: sf.base.getValue('count', _this.grid.dataSource)
          };
        } else {
    ...
    TreeGrid.prototype.bindedDataSource = function () {
      ...
      if (this.dataSource && isCountRequired(this)) {
        ...
        this.grid.dataSource = !(this.dataSource instanceof sf.data.DataManager) ? this.flatData : new sf.data.DataManager(this.dataSource.dataSource, this.dataSource.defaultQuery, this.dataSource.adaptor);
      }
    ...
    TreeGrid.prototype.extendedGridActionEvents = function () {
      ...
      this.grid.actionBegin = function (args) {
        ...
        if (!isRemoteData(_this) && !sf.base.isNullOrUndefined(_this.filterModule) && !isCountRequired(_this) && (_this.grid.filterSettings.columns.length === 0 || _this.grid.searchSettings.key.length === 0)) {
        ...
        if (sf.base.isBlazor() && _this.isServerRendered && args.requestType !== 'filterAfterOpen') {
          ...
          for (var i = 0; i < rows.length; i++) {
            if (rows[i].classList.contains('e-treerowcollapsed') || rows[i].classList.contains('e-treerowexpanded')) {
              _this.enableCollapseAll && args.requestType === 'paging' ? sf.base.removeClass([rows[i]], 'e-treerowexpanded') : sf.base.removeClass([rows[i]], 'e-treerowcollapsed');
              _this.enableCollapseAll && args.requestType === 'paging' ? sf.base.addClass([rows[i]], 'e-treerowcollapsed') : sf.base.addClass([rows[i]], 'e-treerowexpanded');
            }

            var cells = rows[i].querySelectorAll('.e-rowcell');

            var expandicon = cells[_this.treeColumnIndex].getElementsByClassName('e-treegridcollapse')[0] || cells[_this.treeColumnIndex].getElementsByClassName('e-treegridexpand')[0];

            if (expandicon) {
              _this.enableCollapseAll && args.requestType === 'paging' ? sf.base.removeClass([expandicon], 'e-treegridexpand') : sf.base.removeClass([expandicon], 'e-treegridcollapse');
              _this.enableCollapseAll && args.requestType === 'paging' ? sf.base.addClass([expandicon], 'e-treegridcollapse') : sf.base.addClass([expandicon], 'e-treegridexpand');
            }
          }
    ...
    TreeGrid.prototype.autoGenerateColumns = function () {
      if (!this.columns.length && !this.dataModule.isRemote() && Object.keys(this.dataSource).length) {
        this.columns = [];
        var record = void 0; // if (this.dataSource instanceof DataManager) {
    ...
    TreeGrid.prototype.onPropertyChanged = function (newProp, oldProp) {
      ...
      for (var _i = 0, properties_1 = properties; _i < properties_1.length; _i++) {
        ...
        switch (prop) {
          ...
          case 'dataSource':
            this.isLocalData = !(this.dataSource instanceof sf.data.DataManager) || !sf.base.isNullOrUndefined(this.dataSource.ready) || this.dataSource.adaptor instanceof sf.data.RemoteSaveAdaptor;
            this.convertTreeData(this.dataSource);
    ...
    TreeGrid.prototype.updateTreeGridModel = function () {
      this.setProperties({
        filterSettings: sf.grids.getObject('properties', this.grid.filterSettings)
      }, true);
      this.setProperties({
        pageSettings: sf.grids.getObject('properties', this.grid.pageSettings)
      }, true);
      this.setProperties({
        searchSettings: sf.grids.getObject('properties', this.grid.searchSettings)
      }, true);
      this.setProperties({
        sortSettings: sf.grids.getObject('properties', this.grid.sortSettings)
      }, true);
    };
    /**
    ...
    TreeGrid.prototype.getCollapseExpandRecords = function (row, record) {
      if (this.allowPaging && this.pageSettings.pageSizeMode === 'All' && this.isExpandAll && sf.base.isNullOrUndefined(record) && !isRemoteData(this)) {
    ...
    TreeGrid.prototype.expandCollapse = function (action, row, record, isChild) {
      ...
      if ((this.allowPaging && this.pageSettings.pageSizeMode === 'All' || this.enableVirtualization) && !isRemoteData(this) && !isCountRequired(this)) {
        this.notify(localPagedExpandCollapse, {
          action: action,
          row: row,
          record: record
        });
        ...
        if (action === 'expand') {
          ...
          if (isChild && !sf.base.isNullOrUndefined(record[this.expandStateMapping]) && record[this.expandStateMapping] && sf.base.isNullOrUndefined(targetEle)) {
        ...
        if (expandingArgs.childData.length) {
          ...
          for (var i = 0; i < length_1; i++) {
            ...
            if (childData[i]) {
              ...
              if (!sf.base.isNullOrUndefined(childData[i][_this.childMapping]) || childData[i][_this.hasChildMapping] && isCountRequired(_this)) {
    ...
    TreeGrid.prototype.localExpand = function (action, row, record, isChild) {
      ...
      for (var i = 0; i < rows.length; i++) {
        ...
        if (!sf.base.isNullOrUndefined(childRecords[i].childRecords) && (action !== 'expand' || sf.base.isNullOrUndefined(childRecords[i].expanded) || childRecords[i].expanded)) {
    ...
    __decorate([sf.base.Property(0)], TreeGrid.prototype, "frozenRows", void 0);

    __decorate([sf.base.Property(0)], TreeGrid.prototype, "frozenColumns", void 0);

    __decorate([sf.base.Property('Ellipsis')], TreeGrid.prototype, "clipMode", void 0);

    __decorate([sf.base.Property([])], TreeGrid.prototype, "columns", void 0);

    __decorate([sf.base.Property(null)], TreeGrid.prototype, "childMapping", void 0);

    __decorate([sf.base.Property(null)], TreeGrid.prototype, "hasChildMapping", void 0);

    __decorate([sf.base.Property(0)], TreeGrid.prototype, "treeColumnIndex", void 0);

    __decorate([sf.base.Property(null)], TreeGrid.prototype, "idMapping", void 0);

    __decorate([sf.base.Property(null)], TreeGrid.prototype, "parentIdMapping", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "enableCollapseAll", void 0);

    __decorate([sf.base.Property(null)], TreeGrid.prototype, "expandStateMapping", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowRowDragAndDrop", void 0);

    __decorate([sf.base.Property([])], TreeGrid.prototype, "dataSource", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "query", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "cloneQuery", void 0);

    __decorate([sf.base.Property('AllPages')], TreeGrid.prototype, "printMode", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowPaging", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "loadChildOnDemand", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowTextWrap", void 0);

    __decorate([sf.base.Complex({}, TextWrapSettings)], TreeGrid.prototype, "textWrapSettings", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowReordering", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowResizing", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "autoCheckHierarchy", void 0);

    __decorate([sf.base.Complex({}, PageSettings)], TreeGrid.prototype, "pageSettings", void 0);

    __decorate([sf.base.Complex({}, sf.grids.RowDropSettings)], TreeGrid.prototype, "rowDropSettings", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "pagerTemplate", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "showColumnMenu", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "showColumnChooser", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowSorting", void 0);

    __decorate([sf.base.Property(true)], TreeGrid.prototype, "allowMultiSorting", void 0);

    __decorate([sf.base.Complex({}, SortSettings)], TreeGrid.prototype, "sortSettings", void 0);

    __decorate([sf.base.Collection([], AggregateRow)], TreeGrid.prototype, "aggregates", void 0);

    __decorate([sf.base.Complex({}, EditSettings)], TreeGrid.prototype, "editSettings", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowFiltering", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "detailTemplate", void 0);

    __decorate([sf.base.Complex({}, FilterSettings)], TreeGrid.prototype, "filterSettings", void 0);

    __decorate([sf.base.Complex({}, SearchSettings)], TreeGrid.prototype, "searchSettings", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "toolbar", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "toolbarTemplate", void 0);

    __decorate([sf.base.Property('Default')], TreeGrid.prototype, "gridLines", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "contextMenuItems", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "columnMenuItems", void 0);

    __decorate([sf.base.Property()], TreeGrid.prototype, "rowTemplate", void 0);

    __decorate([sf.base.Property('Parent')], TreeGrid.prototype, "copyHierarchyMode", void 0);

    __decorate([sf.base.Property(null)], TreeGrid.prototype, "rowHeight", void 0);

    __decorate([sf.base.Property(true)], TreeGrid.prototype, "enableAltRow", void 0);

    __decorate([sf.base.Property(true)], TreeGrid.prototype, "allowKeyboard", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "enableHover", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "enableAutoFill", void 0);

    __decorate([sf.base.Property('auto')], TreeGrid.prototype, "height", void 0);

    __decorate([sf.base.Property('auto')], TreeGrid.prototype, "width", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "enableVirtualization", void 0);

    __decorate([sf.base.Property('All')], TreeGrid.prototype, "columnQueryMode", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "created", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "load", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "expanding", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "expanded", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "collapsing", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "collapsed", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "cellSave", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "cellSaved", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "actionBegin", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "actionComplete", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beginEdit", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "batchAdd", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "batchDelete", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "batchCancel", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforeBatchAdd", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforeBatchDelete", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforeBatchSave", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "cellEdit", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "actionFailure", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "dataBound", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "dataSourceChanged", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "dataStateChange", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "recordDoubleClick", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowDataBound", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "detailDataBound", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "queryCellInfo", void 0);

    __decorate([sf.base.Property(true)], TreeGrid.prototype, "allowSelection", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowSelecting", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowSelected", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowDeselecting", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowDeselected", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "headerCellInfo", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "cellSelecting", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "columnMenuOpen", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "columnMenuClick", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "cellSelected", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "cellDeselecting", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "cellDeselected", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "resizeStart", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "resizing", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "resizeStop", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "columnDragStart", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "columnDrag", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "columnDrop", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "checkboxChange", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "printComplete", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforePrint", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "toolbarClick", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforeDataBound", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "contextMenuOpen", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "contextMenuClick", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforeCopy", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforePaste", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowDrag", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowDragStart", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowDragStartHelper", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "rowDrop", void 0);

    __decorate([sf.base.Property(-1)], TreeGrid.prototype, "selectedRowIndex", void 0);

    __decorate([sf.base.Complex({}, SelectionSettings)], TreeGrid.prototype, "selectionSettings", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowExcelExport", void 0);

    __decorate([sf.base.Property(false)], TreeGrid.prototype, "allowPdfExport", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "pdfQueryCellInfo", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "pdfHeaderQueryCellInfo", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "excelQueryCellInfo", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "excelHeaderQueryCellInfo", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforeExcelExport", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "excelExportComplete", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "beforePdfExport", void 0);

    __decorate([sf.base.Event()], TreeGrid.prototype, "pdfExportComplete", void 0);

    TreeGrid = TreeGrid_1 = __decorate([sf.base.NotifyPropertyChanges], TreeGrid);
    return TreeGrid;
  }(sf.base.Component);
  /**
  ...
  function editAction(details, control, isSelfReference, addRowIndex, selectedIndex, columnName, addRowRecord) {
    ...
    var treeData = control.dataSource instanceof sf.data.DataManager ? control.dataSource.dataSource.json : control.dataSource;
    var modifiedData = [];
    ...
    if (!isSkip && (action !== 'add' || control.editSettings.newRowPosition !== 'Top' && control.editSettings.newRowPosition !== 'Bottom')) {
      for (var k = 0; k < modifiedData.length; k++) {
        if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(modifiedData[k][key]) === 'object') {
            ...
            if (action === 'delete') {
              ...
              if (action === 'edit') {
                for (j = 0; j < keys.length; j++) {
                  if (treeData[i].hasOwnProperty(keys[j]) && (control.editSettings.mode !== 'Cell' || !sf.base.isNullOrUndefined(batchChanges) && batchChanges[changedRecords].length === 0 || keys[j] === columnName)) {
  ...
  function updateParentRow(key, record, action, control, isSelfReference, child) {
    if ((control.editSettings.newRowPosition === 'Above' || control.editSettings.newRowPosition === 'Below') && (action === 'add' || action === 'batchsave') && !sf.base.isNullOrUndefined(child.parentItem)) {
      ...
      var primaryKeys = control.grid.getPrimaryKeyFieldNames()[0];
      var data = control.grid.dataSource instanceof sf.data.DataManager ? control.grid.dataSource.dataSource.json : control.grid.dataSource;
      ...
      if (!control.enableVirtualization && !sf.base.isNullOrUndefined(row) || !sf.base.isNullOrUndefined(movableRow)) {
        control.renderModule.cellRender({
          data: record,
          cell: row.cells[control.treeColumnIndex] ? row.cells[control.treeColumnIndex] : movableRow.cells[control.treeColumnIndex - control.frozenColumns],
  ...
  function () {
    ...
    RowDD$$1.prototype.updateIcon = function (row, index, args) {
      ...
      for (var i = 0; i < args.rows.length; i++) {
        if (!sf.base.isNullOrUndefined(rowEle) && rowEle.getAttribute('data-uid') === args.rows[i].getAttribute('data-uid') || !sf.grids.parentsUntil(args.target, 'e-gridcontent')) {
    ...
    RowDD$$1.prototype.rowDropped = function (args) {
      ...
      if (!tObj.rowDropSettings.targetID) {
        ...
        if (args.target && sf.base.closest(args.target, '#' + tObj.rowDropSettings.targetID) || sf.grids.parentsUntil(args.target, 'e-treegrid') && sf.grids.parentsUntil(args.target, 'e-treegrid').id === tObj.rowDropSettings.targetID) {
          sf.base.setValue('dropPosition', this.dropPosition, args);
          tObj.trigger(rowDrop, args);
    ...
    RowDD$$1.prototype.dragDropGrid = function (args) {
      ...
      if (dropElement && dropElement.id === this.parent.rowDropSettings.targetID && !isRemoteData(this.parent) && !isCountRequired(this.parent)) {
        ...
        tObj.notify(rowsRemove, {
          indexes: indexes,
          records: records
        });
        srcControl.notify(rowsAdd, {
          toIndex: targetIndex,
          records: records
        });
        tObj.refresh();
    ...
    RowDD$$1.prototype.dropMiddle = function (recordIndex, recordIndex1, args, isSelfReference, isByMethod, i) {
      ...
      var childRecordsLength = sf.base.isNullOrUndefined(childRecords) || childRecords.length === 0 ? recordIndex1 + 1 : childRecords.length + recordIndex1 + 1;
    ...
    RowDD$$1.prototype.recordLevel = function () {
      ...
      if (this.dropPosition === 'middleSegment') {
        ...
        droppedRecord.expanded = true; // if (tObj.isLocalData) {
  ...
  function (_super) {
    ...
    __decorate$9([sf.base.Property()], RowDropSettings$$1.prototype, "targetID", void 0);
  ...
  function (_super) {
    ...
    TreeVirtualRowModelGenerator.prototype.generateRows = function (data, notifyArgs) {
      if (this.parent.dataSource instanceof sf.data.DataManager && this.parent.dataSource.dataSource.url !== undefined && this.parent.dataSource.dataSource.url !== '') {
  ...
  function () {
    ...
    ExcelExport$$1.prototype.generateQuery = function (query, property) {
      if (!sf.base.isNullOrUndefined(property) && property.exportType === 'CurrentPage' && this.parent.allowPaging) {
    ...
    ExcelExport$$1.prototype.manipulateExportProperties = function (property, dtSrc, queryResult) {
      ...
      property.dataSource = new sf.data.DataManager({
        json: dtSrc
      });
      return property;
    };
    ...
    ExcelExport$$1.prototype.finalPageSetup = function (
    /* tslint:disable-next-line:no-any */
    workbook) {
  ...
  function () {
    ...
    PdfExport$$1.prototype.generateQuery = function (query, prop) {
      if (!sf.base.isNullOrUndefined(prop) && prop.exportType === 'CurrentPage' && this.parent.allowPaging) {
    ...
    PdfExport$$1.prototype.manipulatePdfProperties = function (prop, dtSrc, queryResult) {
      ...
      prop.dataSource = new sf.data.DataManager({
        json: dtSrc
      });
      return prop;
    };
    ...
    Toolbar$$1.prototype.refreshToolbar = function (args) {
      ...
      if (args.row.rowIndex === 0 || tObj.getSelectedRecords().length > 1) {
        ...
        if (!sf.base.isNullOrUndefined(tObj.getCurrentViewRecords()[args.row.rowIndex])) {
          if (!sf.base.isNullOrUndefined(tObj.getCurrentViewRecords()[args.row.rowIndex]) && tObj.getCurrentViewRecords()[args.row.rowIndex].level > tObj.getCurrentViewRecords()[args.row.rowIndex - 1].level) {
  ...
  function () {
    ...
    Aggregate$$1.prototype.calculateSummaryValue = function (summaryQuery, filteredData, isSort) {
      ...
      for (var i = 0, len = dataLength; i < len; i++) {
        ...
        if (childRecordsLength) {
          var _loop_1 = function _loop_1(summaryRowIndex, len_1) {
            var item = void 0;
            item = {};

            for (var columnIndex = 0, len_2 = columnLength; columnIndex < len_2; columnIndex++) {
              var field = sf.base.isNullOrUndefined(sf.grids.getObject('field', this_1.parent.columns[columnIndex])) ? this_1.parent.columns[columnIndex] : sf.grids.getObject('field', this_1.parent.columns[columnIndex]);
              item[field] = null;
            }
    ...
    Aggregate$$1.prototype.getChildRecordsLength = function (parentData, flatData) {
      ...
      for (var i = 0, len = recordLength; i < len; i++) {
        record = flatData[i];
        var parent_1 = sf.base.isNullOrUndefined(record.parentItem) ? null : flatData.filter(function (e) {
    ...
    Aggregate$$1.prototype.createSummaryItem = function (itemData, summary) {
      ...
      for (var i = 0, len = summaryColumnLength; i < len; i++) {
        var displayColumn = sf.base.isNullOrUndefined(summary.columns[i].columnName) ? summary.columns[i].field : summary.columns[i].columnName;
    ...
    Aggregate$$1.prototype.getSummaryValues = function (summaryColumn, summaryData) {
      ...
      single = {};
      var helper = {};
      var type = !sf.base.isNullOrUndefined(summaryColumn.field) ? this.parent.getColumnByField(summaryColumn.field).type : undefined;
      ...
      for (var i = 0; i < types.length; i++) {
        ...
        var val = types[i] !== 'Custom' ? sf.grids.getObject('aggregates', sumData) : sf.grids.calculateAggregate(types[i], sumData, summaryColumn, this.parent);
  ...
  function () {
    ...
    Sort$$1.prototype.updateModel = function () {
      this.parent.setProperties({
        sortSettings: sf.grids.getActualProperties(this.parent.grid.sortSettings)
      }, true);
    };
    /**
     * Clears all the sorted columns of the TreeGrid.
  ...
  function () {
    ...
    ColumnMenu$$1.prototype.destroy = function () {//this.parent.grid.columnMenuModule.destroy();
    };
    /**
     * For internal use only - Get the module name.
     * @private
  ...
  function () {
    ...
    ContextMenu$$1.prototype.contextMenuOpen = function (args) {
      ...
      if ((this.parent.editSettings.mode === 'Cell' || this.parent.editSettings.mode === 'Batch') && !sf.base.isNullOrUndefined(editRecord) && !editRecord.classList.contains('e-menu-hide')) {
  ...
  function () {
    ...
    BatchEdit.prototype.batchPageAction = function () {
      var data = this.parent.grid.dataSource instanceof sf.data.DataManager ? this.parent.grid.dataSource.dataSource.json : this.parent.grid.dataSource;
      ...
      if (this.isAdd && this.parent.editSettings.mode === 'Batch' && this.parent.editSettings.newRowPosition !== 'Bottom') {
        ...
        if (this.newBatchRowAdded) {
          ...
          if (!added.hasOwnProperty('level')) {
            ...
            } else if ((this.parent.editSettings.newRowPosition === 'Above' || this.parent.editSettings.newRowPosition === 'Below') && !sf.base.isNullOrUndefined(this.batchRecords[this.addRowIndex])) {
  ...
  function () {
    ...
    Edit$$1.prototype.editActionEvents = function (args) {
      ...
      if ((isRemoteData(treeObj) || adaptor instanceof sf.data.RemoteSaveAdaptor) && eventArgs.requestType === 'save' && eventArgs.action === 'add' && (treeObj.editSettings.newRowPosition === 'Child' || treeObj.editSettings.newRowPosition === 'Below' || treeObj.editSettings.newRowPosition === 'Above')) {
        if (eventName === 'actionBegin') {
          var rowIndex = sf.base.isNullOrUndefined(eventArgs.row) || !Object.keys(eventArgs.row).length ? this.selectedIndex : eventArgs.row.rowIndex - 1;
          var keyData = !sf.base.isNullOrUndefined(rowIndex) && rowIndex !== -1 ? treeObj.getCurrentViewRecords()[rowIndex][treeObj.getPrimaryKeyFieldNames()[0]] : -1;
    ...
    Edit$$1.prototype.recordDoubleClick = function (args) {
      ...
      if (this.parent.editSettings.mode === 'Cell' && !this.isOnBatch && column && !column.isPrimaryKey && column.allowEditing && !(target.classList.contains('e-treegridexpand') || target.classList.contains('e-treegridcollapse')) && this.parent.editSettings.allowEditOnDblClick) {
        this.isOnBatch = true;
        this.parent.grid.setProperties({
    ...
    Edit$$1.prototype.cellEdit = function (args) {
      ...
      if (this.doubleClickTarget && (this.doubleClickTarget.classList.contains('e-treegridexpand') || this.doubleClickTarget.classList.contains('e-treegridcollapse'))) {
        args.cancel = true;
    ...
    Edit$$1.prototype.cellSave = function (args) {
      if (this.parent.editSettings.mode === 'Cell' && this.parent.element.querySelector('form')) {
        ...
        if (sf.base.isNullOrUndefined(row)) {
          ...
          rowIndex_1 = this.parent.getRows().indexOf(row) === -1 && this.parent.frozenColumns > 0 ? this.parent.grid.getMovableRows().indexOf(row) : this.parent.getRows().indexOf(row);
        }
      ...
      if (sf.base.isBlazor() && this.parent.isServerRendered) {
        ...
        for (var i = 0; i < cols.length; i++) {
          if (columnModel[i].template) {
            ...
            columnModel[i].getColumnTemplate()(sf.base.extend({
              'index': [i]
            }, args.rowData), this.parent.grid, 'template', templateID, this.parent.grid[str], null);
          }
    ...
    Edit$$1.prototype.beginAddEdit = function (args) {
      ...
      if (args.action === 'add') {
        var key = this.parent.grid.getPrimaryKeyFieldNames()[0];
        var position = null;
        value.taskData = sf.base.isNullOrUndefined(value.taskData) ? sf.base.extend({}, args.data) : value.taskData; // let currentData: ITreeData[] = this.batchRecords.length ? this.batchRecords :
        ...
        if (this.parent.editSettings.newRowPosition !== 'Top' && currentData.length) {
          ...
          if (this.parent.editSettings.newRowPosition === 'Bottom') {
            var dataSource = this.parent.grid.dataSource instanceof sf.data.DataManager ? this.parent.grid.dataSource.dataSource.json : this.parent.grid.dataSource;
      ...
      if (args.action === 'add') {
        this.internalProperties = {
          ...
          parentUniqueID: sf.base.isNullOrUndefined(value.parentItem) ? undefined : value.parentItem.uniqueID,
    ...
    Edit$$1.prototype.contentready = function (e) {
      if (!sf.base.isNullOrUndefined(e.args.requestType) && (e.args.requestType.toString() === 'delete' || e.args.requestType.toString() === 'save' || this.parent.editSettings.mode === 'Batch' && e.args.requestType.toString() === 'batchsave')) {
  ...
  function () {
    ...
    DetailRow$$1.prototype.dataBoundArg = function () {
      ...
      for (var i = 0; i < detailele.length; i++) {
        ...
        if (sf.base.isNullOrUndefined(parentItem) || !sf.base.isNullOrUndefined(parentItem) && getExpandStatus(this.parent, detailData.data, this.parent.grid.getCurrentViewRecords())) {
    ...
    DetailRow$$1.prototype.detaildataBound = function (args) {
      if (!sf.base.isBlazor() || !this.parent.isServerRendered) {
        ...
        var gridClas = [].slice.call(classlist).filter(function (gridclass) {
          return gridclass === expandClass_1;
        });
  ...
  function (_super) {
    ...
    VirtualTreeContentRenderer.prototype.onDataReady = function (e) {
      ...
      if (!(this.parent.dataSource instanceof sf.data.DataManager && this.parent.dataSource.dataSource.url !== undefined && this.parent.dataSource.dataSource.url !== '')) {
        if (!sf.base.isNullOrUndefined(e.count)) {
          ...
          sf.base.getValue('virtualEle', this).setVirtualHeight(this.parent.getRowHeight() * e.count, '100%'); // this.parent.pageSettings.pageSize - Math.ceil(this.parent.pageSettings.pageSize / 1.5);
        }
    ...
    VirtualTreeContentRenderer.prototype.appendContent = function (target, newChild, e) {
      if (this.parent.dataSource instanceof sf.data.DataManager && this.parent.dataSource.dataSource.url !== undefined && this.parent.dataSource.dataSource.url !== '') {
        ...
        var info = e.virtualInfo.sentinelInfo && e.virtualInfo.sentinelInfo.axis === 'Y' && sf.base.getValue('currentInfo', this).page && sf.base.getValue('currentInfo', this).page !== e.virtualInfo.page ? sf.base.getValue('currentInfo', this) : e.virtualInfo;
        var cBlock = info.columnIndexes[0] - 1;
        var cOffset = this.getColumnOffset(cBlock); //this.virtualEle.setWrapperWidth(width, ( Browser.isIE || Browser.info.name === 'edge') as boolean);
  ...
  function () {
    ...
    VirtualScroll$$1.prototype.collapseExpandVirtualchilds = function (row) {
      this.parent.grid.notify(virtualActionArgs, {
    ...
    VirtualScroll$$1.prototype.virtualPageAction = function (pageingDetails) {
      ...
      this.parent.grid.notify(dataListener, {
        data: visualData
      });
      var counts = {
        startIndex: -1,
  ...
  function (_super) {
    ...
    TreeVirtual.prototype.instantiateRenderers = function () {
      ...
      sf.base.getValue('addRenderer', renderer).apply(renderer, [sf.grids.RenderType.Content, new VirtualTreeContentRenderer(sf.base.getValue('parent', this), sf.base.getValue('locator', this))]); //renderer.addRenderer(RenderType.Content, new VirtualTreeContentRenderer(getValue('parent', this), getValue('locator', this)));
  ...
  function () {
    ...
    Freeze$$1.prototype.dblClickHandler = function (e) {
      if (sf.grids.parentsUntil(e.target, 'e-rowcell') && this.parent.grid.editSettings.allowEditOnDblClick && this.parent.editSettings.mode !== 'Cell') {
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.treegrid, function () {
