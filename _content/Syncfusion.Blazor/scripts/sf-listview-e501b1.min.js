...
window.sfBlazor.ListView = function () {
  ...
  function () {
    ...
    sfListView.prototype.AddActiveClass = function () {
      if (!this.curUl) this.curUl = this.element.querySelector('ul');
      var liCollection = this.enableVirtualization ? this.curUl.querySelector('.' + virtualUlContainer).children : this.curUl.children;
    ...
    sfListView.prototype.setSelectedItems = function (selectedElementIdInfo) {
      ...
      this.curDSKey = dataSource_Key;
      this.curUl = this.element.querySelector('ul');
      this.curUl.style.removeProperty('display');
      this.AddActiveClass();
      this.removeFocus();
