(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["filemanager"],{

/***/ "./bundles/filemanager.js":
/*!********************************!*\
  !*** ./bundles/filemanager.js ***!
  \********************************/
/*! no exports provided */
...
/* harmony import */ var _modules_filemanager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/filemanager.js */ "./modules/filemanager.js");
...
var sffilemanager = function sffilemanager(exports) {
  'use strict';
  ...
  function (_super) {
    ...
    __decorate([sf.base.Property(null)], AjaxSettings.prototype, "downloadUrl", void 0);

    __decorate([sf.base.Property(null)], AjaxSettings.prototype, "getImageUrl", void 0);

    __decorate([sf.base.Property(null)], AjaxSettings.prototype, "uploadUrl", void 0);

    __decorate([sf.base.Property(null)], AjaxSettings.prototype, "url", void 0);
  ...
  function (_super) {
    ...
    __decorate$1([sf.base.Property(toolbarItems)], ToolbarSettings.prototype, "items", void 0);

    __decorate$1([sf.base.Property(true)], ToolbarSettings.prototype, "visible", void 0);
  ...
  function (_super) {
    ...
    __decorate$2([sf.base.Property(true)], SearchSettings.prototype, "allowSearchOnTyping", void 0);

    __decorate$2([sf.base.Property('contains')], SearchSettings.prototype, "filterType", void 0);

    __decorate$2([sf.base.Property(true)], SearchSettings.prototype, "ignoreCase", void 0);
  ...
  function (_super) {
    ...
    __decorate$3([sf.base.Property(true)], DetailsViewSettings.prototype, "columnResizing", void 0);

    __decorate$3([sf.base.Property(columnArray)], DetailsViewSettings.prototype, "columns", void 0);
  ...
  function (_super) {
    ...
    __decorate$4([sf.base.Property(fileItems)], ContextMenuSettings.prototype, "file", void 0);

    __decorate$4([sf.base.Property(folderItems)], ContextMenuSettings.prototype, "folder", void 0);

    __decorate$4([sf.base.Property(layoutItems)], ContextMenuSettings.prototype, "layout", void 0);

    __decorate$4([sf.base.Property(true)], ContextMenuSettings.prototype, "visible", void 0);
  ...
  function (_super) {
    ...
    __decorate$5([sf.base.Property('650px')], NavigationPaneSettings.prototype, "maxWidth", void 0);

    __decorate$5([sf.base.Property('240px')], NavigationPaneSettings.prototype, "minWidth", void 0);

    __decorate$5([sf.base.Property(true)], NavigationPaneSettings.prototype, "visible", void 0);
  ...
  function (_super) {
    ...
    __decorate$6([sf.base.Property('')], UploadSettings.prototype, "allowedExtensions", void 0);

    __decorate$6([sf.base.Property(true)], UploadSettings.prototype, "autoUpload", void 0);

    __decorate$6([sf.base.Property(false)], UploadSettings.prototype, "autoClose", void 0);

    __decorate$6([sf.base.Property(0)], UploadSettings.prototype, "minFileSize", void 0);

    __decorate$6([sf.base.Property(30000000)], UploadSettings.prototype, "maxFileSize", void 0);
  ...
  function (_super) {
    ...
    __decorate$7([sf.base.Property('')], Column.prototype, "field", void 0);

    __decorate$7([sf.base.Property('')], Column.prototype, "headerText", void 0);

    __decorate$7([sf.base.Property('')], Column.prototype, "width", void 0);

    __decorate$7([sf.base.Property('')], Column.prototype, "minWidth", void 0);

    __decorate$7([sf.base.Property('')], Column.prototype, "maxWidth", void 0);

    __decorate$7([sf.base.Property('Left')], Column.prototype, "textAlign", void 0);

    __decorate$7([sf.base.Property(null)], Column.prototype, "headerTextAlign", void 0);

    __decorate$7([sf.base.Property(null)], Column.prototype, "type", void 0);

    __decorate$7([sf.base.Property(null)], Column.prototype, "format", void 0);

    __decorate$7([sf.base.Property(null)], Column.prototype, "template", void 0);

    __decorate$7([sf.base.Property(null)], Column.prototype, "headerTemplate", void 0);

    __decorate$7([sf.base.Property(true)], Column.prototype, "allowSorting", void 0);

    __decorate$7([sf.base.Property(true)], Column.prototype, "allowResizing", void 0);

    __decorate$7([sf.base.Property(null)], Column.prototype, "customAttributes", void 0);

    __decorate$7([sf.base.Property('')], Column.prototype, "hideAtMedia", void 0);

    __decorate$7([sf.base.Property(null)], Column.prototype, "customFormat", void 0);
  ...
  function getParents(element, text, isId, hasId) {
    ...
    while (!sf.base.isNullOrUndefined(el)) {
      if (sf.base.matches(el, '.' + LIST_ITEM)) {
        var parentText = isId ? el.getAttribute('data-uid') : hasId ? el.getAttribute('data-id') : sf.base.select('.' + LIST_TEXT, el).textContent;
  ...
  function createEmptyElement(parent, element, args) {
    ...
    if (sf.base.isNullOrUndefined(element.querySelector('.' + EMPTY))) {
      var emptyDiv = sf.base.createElement('div', {
        className: EMPTY
      });
      var emptyFolder = sf.base.createElement('div', {
        className: LARGE_EMPTY_FOLDER
      });
      var emptyEle = sf.base.createElement('div', {
        className: EMPTY_CONTENT
      });
      var dragFile = sf.base.createElement('div', {
  ...
  function dragStartHandler(parent, args, dragObj) {
    ...
    if (!parent.allowDragAndDrop || parent.activeModule === 'navigationpane' && sf.base.closest(args.element, 'li').getAttribute('data-uid') === parent.pathId[0]) {
      dragArgs.cancel = true;
    }

    if (parent.activeModule === 'navigationpane' && parent.pathId.indexOf(sf.base.closest(args.element, 'li').getAttribute('data-uid')) !== -1) {
  ...
  function paste( // tslint:disable-next-line
  ...
  function createAjax(parent, data, fn, event, operation, targetPath) {
    ...
    var eventArgs = {
      action: sf.base.getValue('action', data),
  ...
  function pasteSuccess( // tslint:disable-next-line
  ...
  function detailsSuccess( // tslint:disable-next-line
  parent, result, path, operation) {
  ...
  function Search( // tslint:disable-next-line
  ...
  function createDialog(parent, text, e, details, replaceItems) {
    ...
    if (sf.base.isNullOrUndefined(parent.dialogObj)) {
      parent.dialogObj = new sf.popups.Dialog({
        ...
        beforeClose: function beforeClose(args) {
  ...
  function getOptions(parent, text, e, details, replaceItems) {
    ...
    switch (text) {
      ...
      case 'MultipleFileDetails':
        ...
        var fileType$$1 = strArr.every(function (val, i, arr) {
          return val === arr[0];
        }) ? strArr[0] === 'Folder' ? 'Folder' : strArr[0].toLocaleUpperCase() + ' Type' : 'Multiple Types';
        var location_1 = details.location;
        options.header = details.name;
        options.content = '<table><tr><td>' + getLocaleText(parent, 'Type') + ':</td><td class="' + VALUE + '">' + fileType$$1 + '</td></tr>' + '<tr><td>' + getLocaleText(parent, 'Size') + ':</td><td>' + details.size + '<span class="' + VALUE + '" title ="' + details.size + '"></span></td></tr>' + '<tr><td>' + getLocaleText(parent, 'Location') + ':</td><td class="' + VALUE + '" title="' + location_1 + '">' + location_1 + '</td></tr>' + '</table>';
        options.buttons = [{
          buttonModel: {
            isPrimary: true,
            content: getLocaleText(parent, 'Button-Ok')
  ...
  function preventKeydown(btnElement) {
    var _loop_1 = function _loop_1(btnCount) {
  ...
  function createImageDialog(parent, header, imageUrl) {
    ...
    var image = sf.base.createElement('img', {
      className: 'e-image',
      attrs: {
        src: imageUrl,
        alt: header
  ...
  function () {
    ...
    LargeIconsView.prototype.onLayoutChange = function (args) {
      if (this.parent.view === 'LargeIcons') {
        ...
        if (sf.base.getValue('name', args) === 'layout-change' && this.parent.fileAction === 'move' && this.parent.isCut && this.parent.selectedNodes && this.parent.selectedNodes.length !== 0) {
    ...
    LargeIconsView.prototype.renderList = function (args) {
      ...
      while (i < items.length) {
        ...
        if (icon === ICON_IMAGE && this.parent.showThumbnail && hasReadAccess(items[i])) {
          ...
          sf.base.setValue('_fm_imageAttr', {
            alt: name_1
          }, items[i]);
        } else {
    ...
    LargeIconsView.prototype.onPathColumn = function () {
      if (this.parent.view === 'LargeIcons' && !sf.base.isNullOrUndefined(this.listObj) && this.parent.breadcrumbbarModule.searchObj.element.value === '' && !this.parent.isFiltered && this.parent.sortBy === 'filterPath') {
    ...
    LargeIconsView.prototype.onpasteInit = function () {
      if (this.parent.activeModule === this.getModuleName()) {
        this.parent.itemData = this.parent.folderPath === '' ? [getPathObject(this.parent)] : [this.getItemObject(sf.base.select('.e-active', this.element))];
      }
    };
    ...
    LargeIconsView.prototype.addSelection = function (data) {
      ...
      if (this.parent.hasId) {
        resultData = new sf.data.DataManager(this.items).executeLocal(new sf.data.Query().where('id', 'equal', this.parent.renamedId, false));
      } else {
        var newData = new sf.data.DataManager(this.items).executeLocal(new sf.data.Query().where('name', 'equal', sf.base.getValue('name', data), false));

        if (newData.length > 0) {
          resultData = new sf.data.DataManager(newData).executeLocal(new sf.data.Query().where('filterPath', 'equal', this.parent.filterPath, false));
        }
      }
  ...
  function () {
      ...
      for (var _i = 0, _a = Object.keys(e.newProp); _i < _a.length; _i++) {
        ...
        switch (prop) {
          case 'searchSettings':
            ...
            if (this.parent.breadcrumbbarModule.searchObj.value && this.parent.breadcrumbbarModule.searchObj.value !== '' && !(!sf.base.isNullOrUndefined(value.allowSearchOnTyping) && sf.base.isNullOrUndefined(value.filterType) && sf.base.isNullOrUndefined(value.ignoreCase))) {
    ...
    BreadCrumbBar.prototype.onPathChange = function () {
      ...
      if (pathNames.length > 0) {
        ...
        for (var i = 0; i < pathNamesLen; i++) {
          ...
          if (i !== 0) {
            var icon = sf.base.createElement('span', {
              className: ICONS
            });
          ...
          if (pathNamesLen - i !== 1) {
            addressATag = sf.base.createElement('a', {
              className: LIST_TEXT
            });
            addressbarLI.setAttribute('tabindex', '0');
          } else {
            addressATag = sf.base.createElement('span', {
              className: LIST_TEXT
            });
          }
    ...
    BreadCrumbBar.prototype.updateBreadCrumbBar = function (addresBarUL) {
      ...
      var searchInput = sf.base.createElement('input', {
        id: id,
        attrs: {
          autocomplete: 'off',
  ...
  function () {
    ...
    ContextMenu$$1.prototype.onBeforeOpen = function (args) {
      ...
      this.disabledItems = [];
      var selected = false;
      var uid; // tslint:disable-next-line
      ...
      if (target.classList.contains(TREE_VIEW) || sf.base.closest(target, 'th') || sf.base.closest(target, '#' + this.parent.element.id + BREADCRUMBBAR_ID) || sf.base.closest(target, '#' + this.parent.element.id + TOOLBAR_ID)) {
        args.cancel = true; // tslint:disable-next-line
        ...
        this.setLayoutItem(target); // tslint:disable-next-line
    ...
    ContextMenu$$1.prototype.updateActiveModule = function () {
      this.parent.activeModule = sf.base.closest(this.menuTarget, '#' + this.parent.element.id + TREE_ID) ? 'navigationpane' : sf.base.closest(this.menuTarget, '#' + this.parent.element.id + GRID_ID) ? 'detailsview' : sf.base.closest(this.menuTarget, '#' + this.parent.element.id + LARGEICON_ID) ? 'largeiconsview' : this.parent.activeModule;
    };
    /* istanbul ignore next */
    ...
    ContextMenu$$1.prototype.setLayoutItem = function (target) {
      ...
      if (!this.parent.allowMultiSelection || this.parent.view === 'LargeIcons' && sf.base.closest(target, '#' + this.parent.element.id + LARGEICON_ID).getElementsByClassName(EMPTY).length !== 0 || this.parent.view === 'Details' && sf.base.closest(target, '#' + this.parent.element.id + GRID_ID).getElementsByClassName(EMPTY).length !== 0) {
  ...
  function (_super) {
    ...
    FileManager.prototype.render = function () {
      this.initialize();
      var slItems = sf.base.isNullOrUndefined(this.selectedItems) ? [] : this.allowMultiSelection ? this.selectedItems : this.selectedItems.slice(this.selectedItems.length - 1);
      this.setProperties({
    ...
    FileManager.prototype.checkMobile = function () {
      return /iphone|ipod|android|blackberry|opera|mini|windows\sce|palm|smartphone|iemobile/i.test(sf.base.Browser.userAgent.toLowerCase()) && /mobile/i.test(sf.base.Browser.userAgent.toLowerCase());
    };
    ...
    __decorate$8([sf.base.Complex({}, AjaxSettings)], FileManager.prototype, "ajaxSettings", void 0);

    __decorate$8([sf.base.Property(false)], FileManager.prototype, "allowDragAndDrop", void 0);

    __decorate$8([sf.base.Property(true)], FileManager.prototype, "allowMultiSelection", void 0);

    __decorate$8([sf.base.Complex({}, ContextMenuSettings)], FileManager.prototype, "contextMenuSettings", void 0);

    __decorate$8([sf.base.Property('')], FileManager.prototype, "cssClass", void 0);

    __decorate$8([sf.base.Complex({}, DetailsViewSettings)], FileManager.prototype, "detailsViewSettings", void 0);

    __decorate$8([sf.base.Property(true)], FileManager.prototype, "enableHtmlSanitizer", void 0);

    __decorate$8([sf.base.Property(false)], FileManager.prototype, "enablePersistence", void 0);

    __decorate$8([sf.base.Property('400px')], FileManager.prototype, "height", void 0);

    __decorate$8([sf.base.Property('LargeIcons')], FileManager.prototype, "view", void 0);

    __decorate$8([sf.base.Complex({}, NavigationPaneSettings)], FileManager.prototype, "navigationPaneSettings", void 0);

    __decorate$8([sf.base.Property('/')], FileManager.prototype, "path", void 0);

    __decorate$8([sf.base.Property(null)], FileManager.prototype, "popupTarget", void 0);

    __decorate$8([sf.base.Complex({}, SearchSettings)], FileManager.prototype, "searchSettings", void 0);

    __decorate$8([sf.base.Property()], FileManager.prototype, "selectedItems", void 0);

    __decorate$8([sf.base.Property(true)], FileManager.prototype, "showFileExtension", void 0);

    __decorate$8([sf.base.Property(null)], FileManager.prototype, "rootAliasName", void 0);

    __decorate$8([sf.base.Property(false)], FileManager.prototype, "showHiddenItems", void 0);

    __decorate$8([sf.base.Property(true)], FileManager.prototype, "showThumbnail", void 0);

    __decorate$8([sf.base.Property('Ascending')], FileManager.prototype, "sortOrder", void 0);

    __decorate$8([sf.base.Complex({}, ToolbarSettings)], FileManager.prototype, "toolbarSettings", void 0);

    __decorate$8([sf.base.Complex({}, UploadSettings)], FileManager.prototype, "uploadSettings", void 0);

    __decorate$8([sf.base.Property('100%')], FileManager.prototype, "width", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "fileLoad", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "fileOpen", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "beforeDownload", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "beforeImageLoad", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "beforePopupClose", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "beforePopupOpen", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "beforeSend", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "created", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "destroyed", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "fileDragStart", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "fileDragging", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "fileDragStop", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "fileDropped", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "fileSelection", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "fileSelect", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "menuClick", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "menuOpen", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "failure", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "popupClose", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "popupOpen", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "success", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "toolbarClick", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "toolbarCreate", void 0);

    __decorate$8([sf.base.Event()], FileManager.prototype, "uploadListCreate", void 0);

    FileManager = FileManager_1 = __decorate$8([sf.base.NotifyPropertyChanges], FileManager);
    return FileManager;
  }(sf.base.Component);
  /**
  ...
  function () {
    ...
    NavigationPane.prototype.onRenameEndParent = function (args) {
      ...
      if (this.renameParent) {
        ...
        if (this.parent.hasId) {
          resultData = new sf.data.DataManager(this.treeObj.getTreeData()).executeLocal(new sf.data.Query().where('id', 'equal', this.parent.renamedId, false));
        } else {
          var nData = new sf.data.DataManager(this.treeObj.getTreeData()).executeLocal(new sf.data.Query().where(this.treeObj.fields.text, 'equal', this.parent.renameText, false));

          if (nData.length > 0) {
            resultData = new sf.data.DataManager(nData).executeLocal(new sf.data.Query().where('_fm_pId', 'equal', id, false));
          }
        }
    ...
    NavigationPane.prototype.onRenameEnd = function (args) {
      if (this.parent.breadcrumbbarModule.searchObj.element.value === '' && !this.parent.isFiltered) {
        ...
        if (this.parent.hasId) {
          resultData = new sf.data.DataManager(data).executeLocal(new sf.data.Query().where('id', 'equal', this.parent.renamedId, false));
        } else {
          var nData = new sf.data.DataManager(data).executeLocal(new sf.data.Query().where(this.treeObj.fields.text, 'equal', this.parent.currentItemText, false));

          if (nData.length > 0) {
            resultData = new sf.data.DataManager(nData).executeLocal(new sf.data.Query().where('filterPath', 'equal', this.parent.filterPath, false));
          }
        }
      ...
      for (var i = 0; i < files.length; i++) {
        if (!files[i].isFile) {
          if (!this.parent.hasId) {
            ...
            var resultData = new sf.data.DataManager(this.treeObj.getTreeData()).executeLocal(new sf.data.Query().where(this.treeObj.fields.text, 'equal', name_2, false));
    ...
    NavigationPane.prototype.selectResultNode = function (resultObj) {
      if (!this.parent.hasId) {
        ...
        var data = new sf.data.DataManager(this.treeObj.getTreeData()).executeLocal(new sf.data.Query().where(this.treeObj.fields.text, 'equal', itemname, false));

        if (data.length > 0) {
          var resultData = new sf.data.DataManager(data).executeLocal(new sf.data.Query().where('filterPath', 'equal', path, false));
    ...
    NavigationPane.prototype.onpasteEnd = function (args) {
      ...
      if (this.parent.hasId) {
        resultData = new sf.data.DataManager(this.treeObj.getTreeData()).executeLocal(new sf.data.Query().where('id', 'equal', sf.base.getValue('id', args.cwd), false));
      } else {
        var nData = new sf.data.DataManager(this.treeObj.getTreeData()).executeLocal(new sf.data.Query().where(this.treeObj.fields.text, 'equal', sf.base.getValue('name', args.cwd), false));

        if (nData.length > 0) {
          resultData = new sf.data.DataManager(nData).executeLocal(new sf.data.Query().where('filterPath', 'equal', sf.base.getValue('filterPath', args.cwd), false));
        }
      }
  ...
  function () {
    ...
    DetailsView.prototype.render = function (args) {
      ...
      if (this.parent.view === 'Details') {
        ...
        this.gridObj = new sf.grids.Grid({
          ...
          width: '100%',
          beforeCopy: function beforeCopy(args) {
            args.cancel = true;
          },
    ...
    DetailsView.prototype.addSelection = function (data) {
      ...
      if (this.parent.hasId) {
        rData = new sf.data.DataManager(items).executeLocal(new sf.data.Query().where('id', 'equal', this.parent.renamedId, false));
      } else {
        var nData = new sf.data.DataManager(items).executeLocal(new sf.data.Query().where('name', 'equal', sf.base.getValue('name', data), false));

        if (nData.length > 0) {
          rData = new sf.data.DataManager(nData).executeLocal(new sf.data.Query().where('filterPath', 'equal', this.parent.filterPath, false));
        }
      }
    ...
    DetailsView.prototype.getFocusedItemIndex = function () {
      return !sf.base.isNullOrUndefined(this.getFocusedItem()) ? parseInt(this.getFocusedItem().getAttribute('aria-rowindex'), 10) : null;
    };
    /* istanbul ignore next */
    // tslint:disable-next-line:max-func-body-length
    ...
    DetailsView.prototype.checkRowsKey = function (items, indexValue, focIndex, e) {
      if (this.gridObj.checkAllRows === 'Uncheck' || this.gridObj.checkAllRows === 'Intermediate') {
        if (e.action !== 'csHome' && e.action !== 'csEnd') {
          ...
          if (e.action === 'csEnd') {
            this.gridObj.selectRows(this.InnerItems(sf.base.isNullOrUndefined(indexValue) ? 0 : indexValue, sf.base.isNullOrUndefined(focIndex) ? items.length - 1 : focIndex, e));
          } else {
            sf.base.isNullOrUndefined(indexValue) ? this.gridObj.selectRow(0) : this.gridObj.selectRows(this.InnerItems(sf.base.isNullOrUndefined(focIndex) ? 0 : focIndex, indexValue, e));
          }
        }
      } else {
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.filemanager, function () {
