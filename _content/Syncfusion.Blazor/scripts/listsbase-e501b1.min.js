(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["listsbase"],{
...
var listsbase = function listsbase(exports) {
  ...
  (function (ListBase) {
    ...
    function createListItemFromJson(createElement, dataSource, options, level, isSingleLevel) {
      ...
      if (dataSource && dataSource.length && !sf.base.isNullOrUndefined(typeofData(dataSource).item) && !typeofData(dataSource).item.hasOwnProperty(fields.id)) {
    ...
    function typeofData(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        if (!sf.base.isNullOrUndefined(data[i])) {
          return match = {
            typeof: _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(data[i]),
            item: data[i]
          };
        }
      }
    ...
    function generateLI(createElement, item, fieldData, fields, className, options) {
      ...
      if (options && !!options.removeBlazorID && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(item) === 'object' && item.hasOwnProperty(blazId)) {
        delete item[blazId];
      }
