    ...
    Clipboard.prototype.paste = function (data, rowIndex, colIndex) {
      ...
      for (var r = 0; r < rows.length; r++) {
        ...
        for (var c = 0; c < cols.length; c++) {
          ...
          col = grid.getColumnByIndex(cIdx); // value = col.getParser() ? col.getParser()(cols[c]) : cols[c];
          ...
          if (col.allowEditing && !col.isPrimaryKey && !col.template) {
            ...
            //if (!args.cancel) {
            if (grid.editModule) {
              if (col.type === 'number') {// grid.editModule.updateCell(rIdx, col.field, parseInt(args.data as string, 10));
              } else {//grid.editModule.updateCell(rIdx, col.field, args.data);
                }
            } //}
  ...
  function () {
    ...
    function RowDD(parent) {
      ...
      this.helper = function (e) {
        ...
        if (document.getElementsByClassName('e-griddragarea').length || gObj.options.rowDropTarget && !e.sender.target.classList.contains('e-selectionbackground') && gObj.options.selectionType !== 'Single' || !gObj.options.rowDropTarget && !parentsUntil(e.sender.target, 'e-rowdragdrop')) {
          return false;
        }

        if (gObj.options.rowDropTarget && gObj.options.selectionMode === 'Row' && gObj.options.selectionType === 'Single') {
      ...
      this.dragStart = function (e) {
        ...
        if (gObj.options.rowDropTarget && dropElem && dropElem.blazor__instance && dropElem.blazor__instance.getModuleName() === 'grid') {
      ...
      this.processDragStop = function (e) {
        ...
        if (gObj.options.rowDropTarget && dropElement && dropElement.blazor__instance && dropElement.blazor__instance.getModuleName() === 'grid') {
    ...
    */
    ...
    SfGrid.prototype.gridKeyDownHandler = function (e) {
      ...
      if (popupElement && e.key != 'Escape') {
        ...
        if ((e.key == "Tab" || e.key == "shiftTab" || e.key == "Enter" || e.key == "shiftEnter") && e.target.tagName == "INPUT") {
    ...
    SfGrid.prototype.mouseDownHandler = function (e) {
      ...
      if (e.button !== 2 && parentsUntil(e.target, 'e-headercell') || sf.base.closest(e.target, ".e-groupdroparea") || sf.base.closest(e.target, ".e-gridpopup") || sf.base.closest(e.target, ".e-summarycell") || sf.base.closest(e.target, ".e-rhandler") || sf.base.closest(e.target, ".e-filtermenudiv") || sf.base.closest(e.target, ".e-filterbarcell") || sf.base.closest(e.target, ".e-groupcaption")) {
    ...
    SfGrid.prototype.keyActionHandler = function (e) {
      ...
      if (e.action === 'enter' && this.element.classList.contains("e-editing") && this.options.editMode !== "Batch") {
        setTimeout(function () {
          return _this.dotNetRef.invokeMethodAsync("EndEdit");
        }, 40);
      }
    };
    ...
    SfGrid.prototype.clientActions = function () {
      ...
      if (this.options.columns.some(function (col) {
