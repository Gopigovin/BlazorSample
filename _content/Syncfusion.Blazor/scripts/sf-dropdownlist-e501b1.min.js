...
window.sfBlazor.DropDownList = function () {
  ...
  function () {
    ...
    SfDropDownList.prototype.keyActionHandler = function (e) {
      ...
      if (e.action !== 'tab' && e.action !== 'close' && e.action !== 'enter' && e.action !== 'open') {
        e.preventDefault();
      }
    };
    ...
    SfDropDownList.prototype.onDocumentClick = function (e) {
      ...
      if (!(!sf.base.isNullOrUndefined(this.popupObj) && sf.base.closest(target, '#' + this.popupObj.element.id)) && !this.containerElement.contains(e.target)) {
        if (this.containerElement.classList.contains(INPUT_FOCUS) || this.isPopupOpen()) {
          this.dotNetRef.invokeMethodAsync(HIDE);
        }
    ...
    SfDropDownList.prototype.isDevice = function () {
  ...
  var DropDownList = {
    ...
    renderPopup: function renderPopup(element, popupElement, popupHolderEle, openEventArgs, options, dataItem) {
