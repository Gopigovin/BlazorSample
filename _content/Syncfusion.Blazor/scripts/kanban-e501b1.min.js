(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["kanban"],{
...
window.sf.kanban = function (exports) {
  'use strict';
  /**
   * Kanban Constants
   */
        ...
        if (!addArgs.cancel) {
          ...
          if (cardData instanceof Array || modifiedData.length > 0) {
            if (!_this.parent.isBlazorRender()) {
              ...
              // tslint:disable-next-line
              _this.parent.interopAdaptor.invokeMethodAsync('AddCards', {
                AddedRecords: addedRecords,
                ChangedRecords: changedRecords
              }, _this.keyField);
            }
            ...
            if (!_this.parent.isBlazorRender()) {
              ...
              // tslint:disable-next-line
              _this.parent.interopAdaptor.invokeMethodAsync('AddCard', {
                Record: cardData
              });
            }
          }
          ...
          if (!_this.parent.isBlazorRender()) {
            var crudArgs = {
              requestType: 'cardCreated',
              cancel: false,
              promise: promise,
              addedRecords: editParms.addedRecords,
              changedRecords: editParms.changedRecords,
        ...
        if (!updateArgs.cancel) {
          ...
          if (cardData instanceof Array) {
            if (!_this.parent.isBlazorRender()) {
              ...
              // tslint:disable-next-line
              _this.parent.interopAdaptor.invokeMethodAsync('UpdateCards', {
                ChangedRecords: cardData
              }, _this.keyField);
            }
          } else {
            if (!_this.parent.isBlazorRender()) {
              ...
              // tslint:disable-next-line
              _this.parent.interopAdaptor.invokeMethodAsync('UpdateCard', _this.keyField, {
                Record: cardData
              });
            }
          }
      ...
      this.parent.trigger(actionBegin, args, function (deleteArgs) {
        if (!deleteArgs.cancel) {
          ...
          if (!_this.parent.isBlazorRender()) {
            ...
            if (cardData instanceof Array) {
              // tslint:disable-next-line
              _this.parent.interopAdaptor.invokeMethodAsync('DeleteCards', {
                DeletedRecords: cardData
              }, _this.keyField);
            } else {
              // tslint:disable-next-line
              _this.parent.interopAdaptor.invokeMethodAsync('DeleteCard', _this.keyField, {
                Record: cardData
              });
            }
          }
      ...
      var _loop_1 = function _loop_1(columnKey) {
        ...
        for (var _i = 0, _a = keyData; _i < _a.length; _i++) {
          ...
          if (data[this_1.parent.sortSettings.field]) {
            ...
            order = data[this_1.parent.sortSettings.field] = (customOrder > 1 ? initialOrder : columnAllDatas.slice(-1)[0][this_1.parent.sortSettings.field]) + customOrder;
            customOrder++;
          }
          ...
          var finalCardsId = finalData.map(function (obj) {
            return obj[_this.parent.cardSettings.headerField];
          });
  ...
  function () {
    ...
    DragAndDrop.prototype.dragHelper = function (e) {
      ...
      this.dragObj.targetClone = sf.base.createElement('div', {
        ...
        styles: 'width:' + sf.base.formatUnit(this.dragObj.element.offsetWidth) + ';height:' + sf.base.formatUnit(this.dragObj.element.offsetHeight)
      });
    ...
    DragAndDrop.prototype.drag = function (e) {
      ...
      this.parent.notify(contentReady, {});
      var cloneCell = sf.base.closest(target, '.' + CONTENT_CELLS_CLASS + ':not(.' + COLLAPSED_CLASS + ')');

      if (cloneCell) {
        this.dragObj.targetClone.style.width = sf.base.formatUnit(cloneCell.offsetWidth - 2 - cardSpace);
      }
    ...
    KanbanDialog.prototype.getDialogContent = function (args, action) {
      if (action === 'Delete') {
        ...
        if (this.parent.dialogSettings.template) {
          ...
          sf.base.append(this.parent.templateParser(this.parent.dialogSettings.template)(args), form);
        } else {
  ...
  function () {
    ...
    MobileLayout.prototype.renderSwimlaneHeader = function () {
      ...
      if (this.parent.isBlazorRender()) {
        ...
        toolbarWrapper = sf.base.createElement('div', {
          className: SWIMLANE_HEADER_CLASS
        });
        toolbarWrapper.innerHTML = '<div class="' + SWIMLANE_HEADER_TOOLBAR_CLASS + '"><div class="' + TOOLBAR_MENU_CLASS + '"><div class="e-icons ' + TOOLBAR_MENU_ICON_CLASS + '"></div></div><div class="' + TOOLBAR_LEVEL_TITLE_CLASS + '"><div class="' + TOOLBAR_SWIMLANE_NAME_CLASS + '"></div></div></div>';
    ...
    MobileLayout.prototype.renderSwimlaneTree = function () {
      ...
      if (!this.parent.isBlazorRender()) {
        ...
        sf.base.setStyleAttribute(this.parent.element.querySelector('.' + SWIMLANE_OVERLAY_CLASS), {
          'height': treeHeight + 'px'
        });
        sf.base.setStyleAttribute(this.parent.element.querySelector('.' + SWIMLANE_CONTENT_CLASS), {
          'top': height + 'px'
        });
          ...
          if (_this.isColumnVisible(column)) {
            ...
            var _loop_4 = function _loop_4(data) {
              ...
              var cardElement = sf.base.createElement('div', {
                ...
                attrs: {
                  'data-id': data[_this.parent.cardSettings.headerField],
                  'data-key': data[_this.parent.keyField],
                  'aria-selected': 'false',
                  'tabindex': '-1'
                }
              });
              ...
              if (_this.parent.cardSettings.template) {
                ...
                if (_this.parent.cardSettings.showHeader) {
                  ...
                  var cardText_1 = sf.base.createElement('div', {
