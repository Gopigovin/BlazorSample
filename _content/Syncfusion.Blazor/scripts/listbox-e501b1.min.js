(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["listbox"],{
  ...
  function (_super) {
    ...
    ListBox.prototype.enableItems = function (items, enable, isValue) {
      ...
      items.forEach(function (item) {
        ...
        if (sf.base.isBlazor() && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(item) === 'object') {
    ...
    ListBox.prototype.setSelection = function (values, isSelect, isText) {
      ...
      if (values) {
        values.forEach(function (value) {
          ...
          if (isText) {
            if (sf.base.isBlazor() && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(value) === 'object') {
