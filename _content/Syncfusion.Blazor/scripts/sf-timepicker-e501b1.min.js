...
window.sfBlazor.TimePicker = function () {
  ...
  function () {
    ...
    SfTimePicker.prototype.renderPopup = function (popupElement, popupHolderEle, openEventArgs, options) {
      ...
      this.listWrapper = sf.base.select('.' + POPUP_CONTENT);
  ...
  var TimePicker = {
    ...
    selectInputText: function selectInputText(element) {
      if (element && element.blazor__instance) {
        element.blazor__instance.selectInputText(element);
      }
    },
    updateListStatus: function updateListStatus(element, index, status) {
      if (element && element.blazor__instance) {
