(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["querybuilder"],{

/***/ "./bundles/querybuilder.js":
/*!*********************************!*\
  !*** ./bundles/querybuilder.js ***!
  \*********************************/
/*! no exports provided */
...
/* harmony import */ var _modules_querybuilder_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/querybuilder.js */ "./modules/querybuilder.js");


/***/ }),

/***/ "./modules/querybuilder.js":
/*!*********************************!*\
  !*** ./modules/querybuilder.js ***!
  \*********************************/
/*! no exports provided */
...
var sfquerybuilder = function sfquerybuilder(exports) {
  'use strict';
  ...
  function (_super) {
    ...
    __decorate([sf.base.Property(null)], Columns.prototype, "field", void 0);

    __decorate([sf.base.Property(null)], Columns.prototype, "label", void 0);

    __decorate([sf.base.Property(null)], Columns.prototype, "type", void 0);

    __decorate([sf.base.Property(null)], Columns.prototype, "values", void 0);

    __decorate([sf.base.Property(null)], Columns.prototype, "operators", void 0);

    __decorate([sf.base.Property()], Columns.prototype, "ruleTemplate", void 0);

    __decorate([sf.base.Property(null)], Columns.prototype, "template", void 0);
    ...
    __decorate([sf.base.Property(null)], Columns.prototype, "format", void 0);

    __decorate([sf.base.Property(null)], Columns.prototype, "step", void 0);

    __decorate([sf.base.Property(null)], Columns.prototype, "value", void 0);

    __decorate([sf.base.Property(null)], Columns.prototype, "category", void 0);
  ...
  function (_super) {
    ...
    __decorate([sf.base.Property(null)], Rule.prototype, "condition", void 0);

    __decorate([sf.base.Collection([], Rule)], Rule.prototype, "rules", void 0);

    __decorate([sf.base.Property(null)], Rule.prototype, "field", void 0);

    __decorate([sf.base.Property(null)], Rule.prototype, "label", void 0);

    __decorate([sf.base.Property(null)], Rule.prototype, "type", void 0);

    __decorate([sf.base.Property(null)], Rule.prototype, "operator", void 0);

    __decorate([sf.base.Property(null)], Rule.prototype, "value", void 0);

    __decorate([sf.base.Property(false)], Rule.prototype, "not", void 0);
  ...
  function (_super) {
    ...
    __decorate([sf.base.Property(true)], ShowButtons.prototype, "ruleDelete", void 0);

    __decorate([sf.base.Property(true)], ShowButtons.prototype, "groupInsert", void 0);

    __decorate([sf.base.Property(true)], ShowButtons.prototype, "groupDelete", void 0);
  ...
  function (_super) {
    ...
    QueryBuilder.prototype.reset = function () {
      ...
      if (this.enableNotCondition) {
        sf.base.removeClass(this.element.querySelectorAll('.e-qb-toggle'), 'e-active-toggle');
      }

      bodeElem.appendChild(this.createElement('div', {
        attrs: {
          class: 'e-rule-list'
        }
      }));
          ...
          for (var i = 0, len = columns.length; i < len; i++) {
            ...
            if (!columns[i].type) {
              if (columnKeys.indexOf(columns[i].field) > -1) {
                ...
                type = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(value);
    ...
    QueryBuilder.prototype.clickEventHandler = function (event) {
      ...
      if (target.className.indexOf('e-collapse-rule') > -1) {
        ...
        animation.animate('.e-query-builder', {
          name: 'SlideLeftIn'
        });
      ...
      if (target.tagName === 'BUTTON' && target.className.indexOf('e-qb-toggle') < 0) {
        if (target.className.indexOf('e-removerule') > -1) {
          ...
          this.actionButton = target;
          this.deleteGroup(sf.base.closest(target, '.e-group-container'));
          ...
          if (this.element.querySelectorAll('.e-group-container').length < 1) {
            ...
            var mRules = sf.base.extend({}, this.rule, {}, true);
      ...
      } else if (target.tagName === 'LABEL' && target.parentElement.className.indexOf('e-btn-group') > -1 || target.className.indexOf('e-qb-toggle') > -1) {
        var element = sf.base.closest(target, '.e-group-container');
        ...
        if (this.enableNotCondition) {
          if (target.className.indexOf('e-qb-toggle') > -1) {
            ...
            if (toggleElem.className.indexOf('e-active-toggle') > -1) {
              sf.base.removeClass([toggleElem], 'e-active-toggle');
              ariaChecked = false;
            } else {
    ...
    QueryBuilder.prototype.selectBtn = function (target, event) {
      if (event.name === 'beforeOpen') {
        if (this.showButtons.groupInsert) {
          sf.base.removeClass([event.element.querySelector('li span.e-addgroup').parentElement], 'e-button-hide');
        } else {
          sf.base.addClass([event.element.querySelector('li span.e-addgroup').parentElement], 'e-button-hide');
        }
      } else if (event.element.children[0].className.indexOf('e-addrule') > -1) {
        this.addRuleElement(sf.base.closest(target, '.e-group-container'), {});
      } else if (event.element.children[0].className.indexOf('e-addgroup') > -1) {
        this.addGroupElement(true, sf.base.closest(target, '.e-group-container'), '', true);
      }
    };
    ...
    QueryBuilder.prototype.addRuleElement = function (target, rule, column, action, parentId, isRuleTemplate) {
      ...
      var args = {
        groupID: target.id.replace(this.element.id + '_', ''),
        cancel: false,
        type: 'insertRule'
      };
      ...
      if (!args.cancel) {
        if (column && column.ruleTemplate) {
          ...
          if (this.element.className.indexOf('e-device') > -1 || this.displayMode === 'Vertical') {
            ...
            sf.base.addClass([element], 'e-flat');
            sf.base.addClass([element], 'e-primary');
          } else {
            sf.base.addClass([element], 'e-round');
            sf.base.addClass([element], 'e-icon-btn');
            var tooltip = new sf.popups.Tooltip({
              content: this.l10n.getConstant('DeleteRule')
            });
            tooltip.appendTo(element);
            element = this.createElement('span', {
              attrs: {
                class: 'e-btn-icon e-icons e-delete-icon'
              }
            });
        ...
        if (ruleElem.previousElementSibling && ruleElem.previousElementSibling.className.indexOf('e-group-container') > -1 && ruleElem.className.indexOf('e-separate-rule') < 0) {
        ...
        if (!column || column && !column.ruleTemplate) {
          dropDownList = new sf.dropdowns.DropDownList({
    ...
    QueryBuilder.prototype.updateAddedRule = function (target, rule, newRule, isRuleTemplate) {
      var groupElem = sf.base.closest(target, '.e-group-container');
      var rules = this.getParentGroup(groupElem);
      var ruleElem = sf.base.closest(target, '.e-rule-container');
      var index = 0;
    ...
    QueryBuilder.prototype.changeRuleTemplate = function (column, element, rule, type) {
      ...
      if (column.ruleTemplate) {
        ...
        var parentId = sf.base.closest(element, '.e-rule-container').id;

        if (this.previousColumn && this.previousColumn.ruleTemplate) {
          sf.base.detach(element.closest('#' + parentId).querySelector('.e-rule-field'));
        }
    ...
    QueryBuilder.prototype.validateFields = function () {
      ...
      if (this.allowValidation) {
        ...
        for (i = 0, len = ruleElemCln.length; i < len; i++) {
          groupElem = sf.base.closest(ruleElemCln[i], '.e-group-container');
          rule = this.getParentGroup(groupElem);
          index = 0;
          indexElem = tempElem = ruleElemCln[i];
          dropDownObj = sf.base.getComponent(ruleElemCln[i].querySelector('.e-rule-field input.e-control'), 'dropdownlist');
          this.selectedColumn = dropDownObj.getDataByValue(dropDownObj.value);
          validateRule = !sf.base.isNullOrUndefined(dropDownObj.index) && this.selectedColumn.validation;
          ...
          if (validateRule && validateRule.isRequired) {
            ...
            if (sf.base.isNullOrUndefined(rule.rules[index].value) || rule.rules[index].value === '' || rule.rules[index].value instanceof Array && valArray.length < 1) {
              ...
              for (var j_1 = 0, jLen = valElem.length; j_1 < jLen; j_1++) {
                ...
                if (element.parentElement.className.indexOf('e-searcher') > -1) {
                  elem = sf.base.closest(element, '.e-multi-select-wrapper');
          ...
          } else if (dropDownObj.element && sf.base.isNullOrUndefined(dropDownObj.index)) {
            if (fieldElem.parentElement.className.indexOf('e-tooltip') < 0) {
              this.renderToolTip(fieldElem.parentElement);
            }
    ...
    QueryBuilder.prototype.refreshLevel = function (obj) {
      ...
      var ruleListElem = sf.base.closest(groupElem, '.e-rule-list');
      obj.groupElement = ruleListElem ? sf.base.closest(ruleListElem, '.e-group-container') : groupElem;
    ...
    QueryBuilder.prototype.groupTemplate = function () {
      ...
      var grpActElem;
      var groupBtn;
      groupElem = this.createElement('div', {
        attrs: {
          class: 'e-group-container'
        }
      });
      groupHdrElem = this.createElement('div', {
        attrs: {
          class: 'e-group-header'
        }
      });
      grpBodyElem = this.createElement('div', {
        attrs: {
          class: 'e-group-body'
        }
      });
      rulesElem = this.createElement('div', {
        attrs: {
          class: 'e-rule-list'
        }
      });
      ...
      groupElem.appendChild(grpBodyElem); // create button group in OR and AND process

      glueElem = this.createElement('div', {
        attrs: {
          class: 'e-lib e-btn-group'
        }
      });

      if (this.enableNotCondition) {
        inputElem = this.createElement('button', {
          attrs: {
            type: 'button',
            class: 'e-qb-toggle'
          }
      ...
      inputElem = this.createElement('input', {
        attrs: {
          type: 'radio',
          class: 'e-btngroup-and',
          value: 'AND'
        }
      });
      ...
      labelElem = this.createElement('label', {
        attrs: {
          class: 'e-lib e-btn e-btngroup-and-lbl e-small'
        },
      ...
      labelElem = this.createElement('label', {
        attrs: {
          class: 'e-lib e-btn e-btngroup-or-lbl e-small'
        },
        innerHTML: this.l10n.getConstant('OR')
      });
      glueElem.appendChild(labelElem);
      groupHdrElem.appendChild(glueElem);
      grpActElem = this.createElement('div', {
        attrs: {
          class: 'e-group-action'
        }
      });
      groupBtn = this.createElement('button', {
        attrs: {
          type: 'button',
          class: 'e-add-btn'
        }
    ...
    QueryBuilder.prototype.ruleTemplate = function () {
      ...
      var clsName;
      ruleElem = this.createElement('div');
      fieldElem = this.createElement('div', {
        attrs: {
          class: 'e-rule-field'
        }
      });
      tempElem = this.createElement('div', {
        attrs: {
          class: 'e-rule-filter'
        }
      });
      filterElem = this.createElement('input', {
        attrs: {
          type: 'text',
          class: 'e-filter-input'
        }
      });
      ...
      delBtnElem = this.createElement('button', {
        attrs: {
          class: clsName
        }
      });
    ...
    QueryBuilder.prototype.addGroupSuccess = function (args, isGroup, eventTarget, condition, isBtnClick) {
      if (!args.cancel && this.element.querySelectorAll('.e-group-container').length <= this.maxGroupCount) {
        ...
        if (isGroup) {
          ...
          dltGroupBtn = this.createElement('button', {
            attrs: {
              class: clsName
            }
          });
          var button = new sf.buttons.Button({
            iconCss: 'e-icons e-delete-icon',
            cssClass: 'e-small e-round'
          });
          button.appendTo(dltGroupBtn);
          var tooltip = new sf.popups.Tooltip({
            content: this.l10n.getConstant('DeleteGroup')
          });
          tooltip.appendTo(dltGroupBtn);
          sf.base.rippleEffect(dltGroupBtn, {
        ...
        if (this.enableNotCondition) {
          var tglBtn = new sf.buttons.Button({
            content: this.l10n.getConstant('NOT'),
            cssClass: 'e-btn e-small'
          });
    ...
    QueryBuilder.prototype.notifyChange = function (value, element, type) {
      var grpElement = sf.base.closest(element, '.e-group-container');
      var rules = this.getParentGroup(grpElement);
      var ruleElement = sf.base.closest(element, '.e-rule-container');
      var index = 0;
      ...
      if (column.ruleTemplate) {
        ...
        var tempColl = sf.base.closest(element, '.e-rule-value').querySelectorAll('.e-template');
        var filterElem = sf.base.closest(element, '.e-rule-container').querySelector('.e-filter-input');
        var dropDownObj = sf.base.getComponent(filterElem, 'dropdownlist');
    ...
    QueryBuilder.prototype.templateChange = function (element, value, type) {
      var grpElem = sf.base.closest(element, '.e-group-container');
      var rules = this.getParentGroup(grpElem);
      var ruleElem = sf.base.closest(element, '.e-rule-container');
      var index = 0;
      ...
      if (this.selectedColumn && this.selectedColumn.ruleTemplate) {
        if (type === 'field' || type === 'operator') {
          var grpEle = sf.base.closest(element, '.e-rule-container');
          this.destroyControls(grpEle, true);
          sf.base.detach(grpEle.querySelector('.e-rule-field'));
          var ruleElement = this.appendRuleElem(sf.base.closest(grpEle, '.e-group-container'), this.selectedColumn, 'change', grpEle.id, type, rule);
    ...
    QueryBuilder.prototype.changeValue = function (i, args) {
      ...
      var groupElem = sf.base.closest(element, '.e-group-container');
      var ruleElem = sf.base.closest(element, '.e-rule-container');
      ...
      if (element.className.indexOf('e-radio') > -1) {
        ...
        dropDownObj = sf.base.getComponent(sf.base.closest(element, '.e-rule-container').querySelector('.e-filter-input'), 'dropdownlist');
        this.selectedColumn = dropDownObj.getDataByValue(dropDownObj.value);
        ...
        value = sf.base.getComponent(element, 'multiselect').value;
      } else {
        value = args.value;
      }
    ...
    QueryBuilder.prototype.changeField = function (args) {
      if (args.isInteracted) {
        ...
        if (column && column.ruleTemplate) {
          ...
          var groupElem = sf.base.closest(args.element, '.e-group-container');
          var rules = this.getParentGroup(groupElem);
          var ruleElem = sf.base.closest(args.element, '.e-rule-container');
          var index = 0;
    ...
    QueryBuilder.prototype.changeRule = function (rule, ddlArgs) {
      ...
      var tempRule = {};
      var filterElem = sf.base.closest(ddlArgs.element, '.e-rule-filter');
      var ddlObj = sf.base.getComponent(ddlArgs.element, 'dropdownlist');
      var element = sf.base.closest(ddlArgs.element, '.e-group-container');
      var groupID = element.id.replace(this.element.id + '_', '');
    ...
    QueryBuilder.prototype.changeFilter = function (flt, dl, grID, rl, tmpRl, dArg) {
      ...
      if (flt) {
        ...
        var ruleElem = sf.base.closest(flt, '.e-rule-container');
        var eventsArgs = void 0;
        var ruleID = ruleElem.id.replace(this.element.id + '_', '');
        eventsArgs = {
          groupID: grID,
          ruleID: ruleID,
          selectedField: dl.value,
          cancel: false,
          type: 'field'
        };
        ...
        var operatorElem = sf.base.closest(dArg.element, '.e-rule-operator');
    ...
    QueryBuilder.prototype.changeOperator = function (flt, opr, dl, grID, rl, tmpRl, dArg) {
      ...
      if (opr) {
        ruleElem = sf.base.closest(opr, '.e-rule-container');
        ruleID = ruleElem.id.replace(this.element.id + '_', '');
        eventsArgs = {
          groupID: grID,
          ruleID: ruleID,
          selectedIndex: dl.index,
          cancel: false,
          type: 'operator'
        };
    ...
    QueryBuilder.prototype.fieldChangeSuccess = function (args, tempRule, filterElem, rule, ddlArgs) {
      var ruleElem = sf.base.closest(filterElem, '.e-rule-container');
      ...
      for (var i = 0; i < tooltipElem.length; i++) {
        sf.base.getComponent(tooltipElem[i], 'tooltip').destroy();
      }
    ...
    QueryBuilder.prototype.operatorChangeSuccess = function (eventsArgs, filterElem, tempRule, rule, ddlArgs) {
      if (!eventsArgs.cancel) {
        ...
        } else if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(rule.value) === 'object' && rule.value != null) {
        ...
        if (tempRule.operator.indexOf('null') > -1 || tempRule.operator.indexOf('empty') > -1) {
          ...
          sf.base.removeClass([parentElem], 'e-show');
          sf.base.addClass([parentElem], 'e-hide');
        }
    ...
    QueryBuilder.prototype.changeRuleValues = function (filterElem, rule, tempRule, ddlArgs) {
      ...
      if (filterElem) {
        ...
        sf.base.addClass([operatorElem], 'e-operator');

        if (operatorElem.childElementCount) {
          ddlObj = sf.base.getComponent(operatorElem.querySelector('.e-dropdownlist'), 'dropdownlist');
          ...
          var ruleId = sf.base.closest(operatorElem, '.e-rule-container').id;
          oprElem = this.createElement('input', {
            attrs: {
              type: 'text',
              id: ruleId + '_operatorkey'
            }
          });
    ...
    QueryBuilder.prototype.destroyControls = function (target, isRuleTemplate) {
      ...
      for (var i = 0, len = inputElement.length; i < len; i++) {
        if (inputElement[i].classList.contains('e-textbox')) {
          sf.base.getComponent(inputElement[i], 'textbox').destroy();
          sf.base.detach(element.querySelector('input#' + inputElement[i].id));
        } else if (inputElement[i].classList.contains('e-dropdownlist')) {
          sf.base.getComponent(inputElement[i], 'dropdownlist').destroy();
        } else if (inputElement[i].classList.contains('e-radio')) {
          sf.base.getComponent(inputElement[i], 'radio').destroy();
        } else if (inputElement[i].classList.contains('e-numerictextbox')) {
          sf.base.getComponent(inputElement[i], 'numerictextbox').destroy();
          sf.base.detach(element.querySelector('input#' + inputElement[i].id));
        } else if (inputElement[i].classList.contains('e-datepicker')) {
          sf.base.getComponent(inputElement[i], 'datepicker').destroy();
        } else if (inputElement[i].classList.contains('e-multiselect')) {
          sf.base.getComponent(inputElement[i], 'multiselect').destroy();
      ...
      for (var i = 0, len = templateElement.length; i < len; i++) {
        sf.base.detach(templateElement[i]);
      }
    };
    ...
    QueryBuilder.prototype.renderMultiSelect = function (rule, parentId, i, selectedValue, values) {
      ...
      var multiSelectObj = new sf.dropdowns.MultiSelect({
        dataSource: isValues ? values : isFetched ? ds : this.dataManager,
        query: new sf.data.Query([rule.field]),
        fields: {
          text: rule.field,
          value: rule.field
        },
    ...
    QueryBuilder.prototype.multiSelectOpen = function (parentId, args) {
      if (this.dataSource instanceof sf.data.DataManager) {
        ...
        var dropDownObj = sf.base.getComponent(sf.base.closest(element, '.e-rule-container').querySelector('.e-filter-input'), 'dropdownlist');
        this.selectedColumn = dropDownObj.getDataByValue(dropDownObj.value);
    ...
    QueryBuilder.prototype.getMultiSelectData = function (element, value) {
      ...
      var data = this.dataManager.executeQuery(new sf.data.Query().select(value));
      var multiselectObj = sf.base.getComponent(element, 'multiselect');
      multiselectObj.hideSpinner();
      this.createSpinner(sf.base.closest(element, '.e-multi-select-wrapper').parentElement);
      sf.popups.showSpinner(sf.base.closest(element, '.e-multi-select-wrapper').parentElement);
      data.then(function (e) {
        ...
        _this.dataColl = sf.base.extend(_this.dataColl, dummyData, [], true);
        multiselectObj.dataSource = _this.getDistinctValues(_this.dataColl, value);
        sf.popups.hideSpinner(sf.base.closest(element, '.e-multi-select-wrapper').parentElement);
      }).catch(function (e) {
        deferred.reject(e);
      });
    };
    ...
    QueryBuilder.prototype.createSpinner = function (element) {
      var spinnerElem = this.createElement('span', {
        attrs: {
          class: 'e-qb-spinner'
        }
      });
    ...
    QueryBuilder.prototype.closePopup = function (i, args) {
      ...
      var value = sf.base.getComponent(element, 'multiselect').value;
    ...
    QueryBuilder.prototype.processTemplate = function (target, itemData, rule, tempRule) {
      ...
      if (tempElements.length < 2) {
        if (itemData.template && typeof itemData.template.write === 'string') {
          sf.base.getValue(itemData.template.write, window)({
            elements: tempElements[0],
            values: rule.value,
    ...
    QueryBuilder.prototype.setDefaultValue = function (parentId, isArryValue, isNumber) {
      ...
      if (sf.base.isNullOrUndefined(itemData.value)) {
    ...
    QueryBuilder.prototype.renderStringValue = function (parentId, rule, operator, idx, ruleValElem) {
      ...
      if ((operator === 'in' || operator === 'notin') && (this.dataColl.length || columnData.values)) {
        ...
        var inputobj = new sf.inputs.TextBox({
          placeholder: this.l10n.getConstant('SelectValue'),
    ...
    QueryBuilder.prototype.renderNumberValue = function (parentId, rule, operator, idx, ruleValElem, itemData, length) {
      ...
      if ((operator === 'in' || operator === 'notin') && (this.dataColl.length || columnData.values)) {
        ...
        var numeric = new sf.inputs.NumericTextBox({
    ...
    QueryBuilder.prototype.parseDate = function (value, format) {
      ...
      if (format) {
        var dParser = this.intl.getDateParser({
          skeleton: 'full',
          type: 'dateTime'
        });
        ...
        if (sf.base.isNullOrUndefined(selectedValue)) {
    ...
    QueryBuilder.prototype.renderControls = function (target, itemData, rule, tempRule) {
      sf.base.addClass([target.parentElement.querySelector('.e-rule-value')], 'e-value');
      sf.base.removeClass([target.parentElement.querySelector('.e-rule-value')], 'e-hide');
      sf.base.addClass([target.parentElement.querySelector('.e-rule-value')], 'e-show');
              ...
              case 'date':
                {
                  ...
                  if (format) {
                    ...
                    if (formatObj.skeleton) {
                      datepick = new sf.calendars.DatePicker({
      ...
      if (!(operator.indexOf('null') > -1 || operator.indexOf('empty') > -1)) {
        ...
        if (itemData.template) {
          ...
          if (itemData.template && typeof itemData.template.create === 'string') {
            valElem = sf.base.getValue(itemData.template.create, window)({
              field: column.field,
              operator: itemData.value || operator
            });
          ...
          sf.base.removeClass([target.nextElementSibling], 'e-template-value');
          var inputLen = 1;
          ...
          for (var i = 0; i < inputLen; i++) {
            var valElem = void 0;
            valElem = this.createElement('input', {
              attrs: {
                type: 'text',
                id: parentId + '_valuekey' + i
              }
            });
            target.nextElementSibling.appendChild(valElem);
          }
    ...
    QueryBuilder.prototype.updateValues = function (element, rule) {
      ...
      switch (controlName) {
        case 'textbox':
          rule.value = sf.base.getComponent(element, controlName).value;
          break;
        ...
        case 'numerictextbox':
          if (rule.operator.indexOf('between') > -1) {
            ...
            rule.value[i] = sf.base.getComponent(element, controlName).value;
          } else {
            rule.value = sf.base.getComponent(element, controlName).value;
          }
        ...
        case 'datepicker':
          var column = this.getColumn(rule.field);
          var format = this.getFormat(column.format);
          var selectedDate = sf.base.getComponent(element, controlName).value;
          ...
          } else if (sf.base.isNullOrUndefined(format.format) && selectedDate) {
    ...
    QueryBuilder.prototype.updateRules = function (target, selectedValue, i) {
      ...
      if (sf.base.closest(target, '.e-rule-filter')) {
        ...
        rule.rules[index].operator = operator; // Value Fields
        ...
        if (this.allowValidation && rule.rules[index].field && target.parentElement.className.indexOf('e-tooltip') > -1) {
          sf.base.getComponent(target.parentElement, 'tooltip').destroy();
        }
      ...
      } else if (sf.base.closest(target, '.e-rule-value')) {
    ...
    QueryBuilder.prototype.filterRules = function (beforeRule, afterRule, type) {
      var beforeRuleStr = JSON.stringify({
        condition: beforeRule.condition,
        not: beforeRule.not,
        rule: beforeRule.rules
      });
      var afetrRuleStr = JSON.stringify({
        condition: afterRule.condition,
        not: afterRule.not,
        rule: afterRule.rules
      });

      if (beforeRuleStr !== afetrRuleStr) {
        if (!this.isImportRules) {
          this.trigger('ruleChange', {
            previousRule: beforeRule,
            rule: afterRule,
            type: type
          });
        }
    ...
    QueryBuilder.prototype.ruleValueUpdate = function (target, selectedValue, rule, index, groupElem, ruleElem, i) {
      ...
      if (selectedValue !== null) {
        if (target.className.indexOf('e-multiselect') > -1 && rule.rules[index].type === 'number' && !(target.className.indexOf('e-template') > -1)) {
          var selVal = [];
        ...
        if (target.classList.contains('e-blazor-template') || target.className.indexOf('e-template') > -1) {
          ...
          eventsArgs = {
            groupID: groupElem.id,
            ruleID: ruleElem.id,
            value: rule.rules[index].value,
            type: 'value'
          };
    ...
    QueryBuilder.prototype.validatValue = function (rule, index, ruleElem) {
      if (this.allowValidation && rule.rules[index].value) {
        ...
        if (valElem[0].className.indexOf('e-tooltip') > -1) {
          sf.base.getComponent(valElem[0], 'tooltip').destroy();
        } else if (valElem[0].parentElement.className.indexOf('e-tooltip') > -1) {
          sf.base.getComponent(valElem[0].parentElement, 'tooltip').destroy();
        }

        if (valElem[1] && valElem[1].parentElement.className.indexOf('e-tooltip') > -1) {
          sf.base.getComponent(valElem[1].parentElement, 'tooltip').destroy();
        }
      }
    };
    ...
    QueryBuilder.prototype.destroy = function () {
      ...
      for (i = 0; i < len; i++) {
        sf.base.getComponent(element[i], 'dropdown-btn').destroy();
        sf.base.detach(element[i]);
      }

      tooltip = this.element.querySelectorAll('.e-rule-filter .e-control.e-tooltip');

      for (i = 0; i < tooltip.length; i++) {
        sf.base.getComponent(tooltip[i], 'tooltip').destroy();
      }
      ...
      for (i = 0; i < len; i++) {
        sf.base.getComponent(element[i], 'dropdownlist').destroy();
        sf.base.detach(element[i]);
      }
      ...
      sf.base.classList(this.element, [], ['e-rtl', 'e-responsive', 'e-device']);
    };
    /**
    ...
    QueryBuilder.prototype.initWrapper = function () {
      ...
      if (this.cssClass) {
        sf.base.addClass([this.element], this.cssClass);
      }

      if (this.enableRtl) {
        sf.base.addClass([this.element], 'e-rtl');
      }
      ...
      if (sf.base.Browser.isDevice || this.displayMode === 'Vertical') {
        if (sf.base.Browser.isDevice) {
          this.element.style.width = '100%';
          this.element.classList.add('e-device');
        }

        sf.base.removeClass(this.element.querySelectorAll('.e-rule-container'), 'e-horizontal-mode');
        sf.base.addClass(this.element.querySelectorAll('.e-rule-container'), 'e-vertical-mode');
    ...
    QueryBuilder.prototype.renderSummary = function () {
      ...
      var textElem = this.createElement('textarea', {
        attrs: {
          class: 'e-summary-text',
          readonly: 'true'
        },
        styles: 'max-height:500px'
      });
      var editElem = this.createElement('button', {
        attrs: {
          class: 'e-edit-rule e-css e-btn e-small e-flat e-primary'
        }
      });
      var divElem = this.createElement('div', {
        attrs: {
          class: 'e-summary-btndiv'
        }
      });
    ...
    QueryBuilder.prototype.columnSort = function () {
      if (this.sortDirection.toLowerCase() === 'descending') {
        this.columns = new sf.data.DataManager(this.columns).executeLocal(new sf.data.Query().sortByDesc('field'));
      } else if (this.sortDirection.toLowerCase() === 'ascending') {
        this.columns = new sf.data.DataManager(this.columns).executeLocal(new sf.data.Query().sortBy('field'));
      }
    };
    ...
    QueryBuilder.prototype.onChangeNotGroup = function () {
      ...
      if (this.enableNotCondition) {
        if (this.enableNotCondition) {
          var inputElem = this.createElement('button', {
            attrs: {
              type: 'button',
              class: 'e-qb-toggle'
            }
    ...
    QueryBuilder.prototype.notGroupRtl = function () {
      if (this.enableRtl) {
        sf.base.addClass(this.element.querySelectorAll('.e-btn-group'), 'e-rtl');
      } else {
        sf.base.removeClass(this.element.querySelectorAll('.e-btn-group'), 'e-rtl');
      }
    };
    ...
    QueryBuilder.prototype.checkNotGroup = function (rule) {
      ...
      if (!sf.base.isNullOrUndefined(rule.not)) {
        if (this.enableNotCondition) {
          rule.not = false;
        }

        delete rule.not;
      } else if (this.enableNotCondition && !sf.base.isNullOrUndefined(rule.condition)) {
        rule.not = false;
      }
        ...
        switch (prop) {
          ...
          case 'showButtons':
            if (newProp.showButtons.ruleDelete) {
              sf.base.removeClass(this.element.querySelectorAll('.e-rule-delete'), 'e-button-hide');
            } else {
              sf.base.addClass(this.element.querySelectorAll('.e-rule-delete'), 'e-button-hide');
            }

            if (newProp.showButtons.groupDelete) {
              sf.base.removeClass(this.element.querySelectorAll('.e-deletegroup'), 'e-button-hide');
            } else {
              sf.base.addClass(this.element.querySelectorAll('.e-deletegroup'), 'e-button-hide');
            }
          ...
          case 'enableRtl':
            if (newProp.enableRtl) {
              ...
              sf.base.removeClass([this.element], 'e-rtl');
              this.notGroupRtl();
            }
          ...
          case 'locale':
            ...
            this.intl = new sf.base.Internationalization(this.locale);
            this.isLocale = true;
            this.refresh();
            this.isLocale = false;
            break;
    ...
    QueryBuilder.prototype.preRender = function () {
      ...
      this.l10n = new sf.base.L10n('querybuilder', this.defaultLocale, this.locale);
      this.intl = new sf.base.Internationalization(this.locale);
      this.groupIdCounter = 0;
      ...
      this.customOperators = {
        stringOperator: [{
          value: 'startswith',
          key: this.l10n.getConstant('StartsWith')
        }, {
          value: 'endswith',
          key: this.l10n.getConstant('EndsWith')
        }, {
          value: 'contains',
          key: this.l10n.getConstant('Contains')
        }, {
          value: 'equal',
          key: this.l10n.getConstant('Equal')
        }, {
          value: 'notequal',
          key: this.l10n.getConstant('NotEqual')
        }, {
          value: 'in',
          key: this.l10n.getConstant('In')
        }, {
          value: 'notin',
          key: this.l10n.getConstant('NotIn')
        }, {
          value: 'isempty',
          key: this.l10n.getConstant('IsEmpty')
        }, {
          value: 'isnotempty',
          key: this.l10n.getConstant('IsNotEmpty')
        }],
        dateOperator: [{
          value: 'equal',
          key: this.l10n.getConstant('Equal')
          ...
          value: 'greaterthan',
          key: this.l10n.getConstant('GreaterThan')
        }, {
          value: 'greaterthanorequal',
          key: this.l10n.getConstant('GreaterThanOrEqual')
        }, {
          value: 'lessthan',
          key: this.l10n.getConstant('LessThan')
        }, {
          value: 'lessthanorequal',
          key: this.l10n.getConstant('LessThanOrEqual')
        }, {
          value: 'notequal',
          key: this.l10n.getConstant('NotEqual')
        }],
        ...
        numberOperator: [{
          ...
          value: 'between',
          key: this.l10n.getConstant('Between')
        }, {
          value: 'lessthan',
          key: this.l10n.getConstant('LessThan')
        }, {
          value: 'notbetween',
          key: this.l10n.getConstant('NotBetween')
        }, {
          value: 'lessthanorequal',
          key: this.l10n.getConstant('LessThanOrEqual')
        }, {
    ...
    QueryBuilder.prototype.render = function () {
      ...
      if (!sf.base.isBlazor()) {
        var stringOper = [{
          value: 'isnull',
          key: this.l10n.getConstant('IsNull')
        }, {
          value: 'isnotnull',
          key: this.l10n.getConstant('IsNotNull')
        }];
        var numberOper = [{
          value: 'isnull',
          key: this.l10n.getConstant('IsNull')
      ...
      if (this.dataSource instanceof sf.data.DataManager) {
        ...
        this.dataManager = new sf.data.DataManager(this.dataSource);
        this.dataColl = this.dataManager.executeLocal(new sf.data.Query());
        this.initControl();
      }
    ...
    QueryBuilder.prototype.deleteGroupSuccessCallBack = function (args, target) {
      if (!args.cancel) {
        if (this.actionButton) {
          sf.base.getComponent(this.actionButton, 'tooltip').destroy();
        }
        ...
        for (i = 0; i < len; i++) {
          sf.base.getComponent(valElem[i], 'tooltip').destroy();
        }
        ...
        if (nextElem && nextElem.className.indexOf('e-separate-rule') > -1) {
          sf.base.removeClass([nextElem], 'e-separate-rule');
          sf.base.addClass([nextElem], 'e-joined-rule');

          if (prevElem && prevElem.className.indexOf('e-rule-container') > -1) {
            sf.base.addClass([prevElem], 'e-prev-joined-rule');
          }
        }
    ...
    QueryBuilder.prototype.deleteRule = function (target) {
      ...
      ruleID = sf.base.closest(target, '.e-rule-container').id.replace(this.element.id + '_', '');
      var args = {
        groupID: groupID,
        ruleID: ruleID,
        cancel: false,
    ...
    QueryBuilder.prototype.deleteRuleSuccessCallBack = function (args, target) {
      if (!args.cancel) {
        ...
        if (!prevElem || prevElem.className.indexOf('e-rule-container') < 0) {
          if (nextElem) {
            sf.base.removeClass([nextElem], 'e-joined-rule');
          }
        }

        if (!nextElem || nextElem.className.indexOf('e-rule-container') < 0) {
          if (prevElem) {
            sf.base.removeClass([prevElem], 'e-prev-joined-rule');
          }
        }

        sf.base.detach(clnruleElem);
    ...
    QueryBuilder.prototype.getValidRules = function (currentRule) {
      ...
      var ruleColl = sf.base.extend([], currentRule.rules, [], true);
      var rule = this.getRuleCollection({
        condition: ruleCondtion,
        rules: ruleColl,
        not: notCondition
      }, true);
      return rule;
    ...
    QueryBuilder.prototype.setRules = function (rule) {
      var mRules = sf.base.extend({}, rule, {}, true);
      this.setGroupRules(mRules);
    };
    /**
    ...
    QueryBuilder.prototype.getRule = function (elem) {
      ...
      if (elem instanceof HTMLElement) {
        ruleElem = sf.base.closest(elem, '.e-rule-container');
      } else {
        ruleId = this.element.id + '_' + elem;
        ruleElem = document.getElementById(ruleId);
      }

      var groupElem = sf.base.closest(ruleElem, '.e-group-container');
      var rule = this.getParentGroup(groupElem);
    ...
    QueryBuilder.prototype.getGroup = function (target) {
      if (target instanceof Element && target.className.indexOf('e-group-container') < 1) {
        target = sf.base.closest(target, '.e-group-container');
      }
    ...
    QueryBuilder.prototype.getFilteredRecords = function () {
      ...
      dataManagerQuery = sf.base.isNullOrUndefined(predicate) ? new sf.data.Query() : new sf.data.Query().where(predicate);

      if (sf.base.isBlazor()) {
        var adaptr = new sf.data.UrlAdaptor();
        var dm = new sf.data.DataManager({
          url: '',
          adaptor: new sf.data.UrlAdaptor()
        });
    ...
    QueryBuilder.prototype.getDataManagerQuery = function (rule) {
      ...
      if (rule.rules.length) {
        query = new sf.data.Query().select(fields).where(predicate);
      } else {
        query = new sf.data.Query().select(fields);
      }
    ...
    QueryBuilder.prototype.getPredicate = function (rule) {
      ...
      for (var i = 0, len = ruleColl.length; i < len; i++) {
        ...
        if (keys.indexOf('rules') > -1 && ruleColl[i].rules) {
          ...
          if (i === 0) {
            if (isDateFilter || (oper.indexOf('in') > -1 || oper.indexOf('between') > -1 || oper.indexOf('null') > -1 || oper.indexOf('empty') > -1) && oper.indexOf('contains') < 0) {
              ...
              if (value !== '' && ignoreOper.indexOf(oper) < 0) {
                pred = new sf.data.Predicate(ruleColl[i].field, ruleColl[i].operator, ruleValue, ignoreCase);
              }
            }
          } else {
    ...
    QueryBuilder.prototype.getLocale = function () {
      var gregorianFormat = sf.base.isBlazor() ? '.dates.days.short' : '.dates.calendars.gregorian.days.format.short';
      var localeString = this.locale;
      var mainVal = sf.base.isBlazor() ? '' : 'main.';
      var cultureObj = sf.base.getValue(mainVal + '' + this.locale + gregorianFormat, sf.base.cldrData);
    ...
    QueryBuilder.prototype.datePredicate = function (ruleColl, value, predicate, condition) {
      ...
      switch (ruleColl.operator) {
        case 'equal':
          pred = new sf.data.Predicate(ruleColl.field, 'greaterthanorequal', value);
          pred = pred.and(ruleColl.field, 'lessthan', nextDate);
          break;

        case 'notequal':
          pred = new sf.data.Predicate(ruleColl.field, 'lessthan', value);
          pred = pred.or(ruleColl.field, 'greaterthanorequal', nextDate);
          break;

        case 'greaterthan':
          pred = new sf.data.Predicate(ruleColl.field, 'greaterthanorequal', nextDate);
          break;

        case 'lessthanorequal':
          pred = new sf.data.Predicate(ruleColl.field, 'lessthan', nextDate);
          break;
      }
    ...
    QueryBuilder.prototype.arrayPredicate = function (ruleColl, predicate, condition) {
      ...
      if (operator.indexOf('null') > -1 || operator.indexOf('empty') > -1) {
        switch (operator) {
          ...
          case 'isnotnull':
            pred = new sf.data.Predicate(ruleColl.field, 'notnull', nullValue);
            break;

          case 'isempty':
            pred = new sf.data.Predicate(ruleColl.field, 'equal', '');
            break;

          case 'isnotempty':
            pred = new sf.data.Predicate(ruleColl.field, 'notequal', '');
            break;
        }
      }
              ...
              switch (operator) {
                case 'between':
                  if (column.type === 'date') {
                    ...
                    pred = new sf.data.Predicate(ruleColl.field, 'greaterthanorequal', value[j]);
                  }
                ...
                case 'notbetween':
                  if (column.type === 'date') {
                    pred = new sf.data.Predicate(ruleColl.field, 'lessthan', this.getDate(value[j], format));
                  } else {
                    pred = new sf.data.Predicate(ruleColl.field, 'lessthan', value[j]);
                  }

                  break;

                case 'in':
                  pred = new sf.data.Predicate(ruleColl.field, 'equal', value[j]);
                  break;

                case 'notin':
                  pred = new sf.data.Predicate(ruleColl.field, 'notequal', value[j]);
                  break;
              }
            } else {
              switch (ruleColl.operator) {
    ...
    QueryBuilder.prototype.importRules = function (rule, parentElem, isReset) {
      if (!isReset) {
        ...
        if (this.enableNotCondition) {
          ...
          if (rule.not) {
            sf.base.addClass([tglBtnElem], 'e-active-toggle');
          } else {
            sf.base.removeClass([tglBtnElem], 'e-active-toggle');
          }
        }
      }
      ...
      if (!sf.base.isNullOrUndefined(ruleColl)) {
        for (var i = 0, len = ruleColl.length; i < len; i++) {
          var keys = Object.keys(ruleColl[i]);

          if (!sf.base.isNullOrUndefined(ruleColl[i].rules) && keys.indexOf('rules') > -1) {
      ...
      parentElem = sf.base.closest(parentElem, '.e-rule-list');

      if (parentElem) {
        parentElem = sf.base.closest(parentElem, '.e-group-container');
      }
    ...
    QueryBuilder.prototype.enableBtnGroup = function () {
      ...
      elems.forEach(function (elem) {
        ...
        } else if (elem.classList.contains('e-btn-disable')) {// do nothing
        } else {
          elem.classList.add('e-readonly');
        }
      });
    ...
    __decorate([sf.base.Event()], QueryBuilder.prototype, "created", void 0);

    __decorate([sf.base.Event()], QueryBuilder.prototype, "actionBegin", void 0);

    __decorate([sf.base.Event()], QueryBuilder.prototype, "beforeChange", void 0);

    __decorate([sf.base.Event()], QueryBuilder.prototype, "change", void 0);

    __decorate([sf.base.Event()], QueryBuilder.prototype, "ruleChange", void 0);
    ...
    __decorate([sf.base.Property(false)], QueryBuilder.prototype, "summaryView", void 0);

    __decorate([sf.base.Property(false)], QueryBuilder.prototype, "allowValidation", void 0);

    __decorate([sf.base.Property([])], QueryBuilder.prototype, "columns", void 0);

    __decorate([sf.base.Property('')], QueryBuilder.prototype, "cssClass", void 0);

    __decorate([sf.base.Property([])], QueryBuilder.prototype, "dataSource", void 0);

    __decorate([sf.base.Property('Horizontal')], QueryBuilder.prototype, "displayMode", void 0);

    __decorate([sf.base.Property(false)], QueryBuilder.prototype, "enablePersistence", void 0);

    __decorate([sf.base.Property('Default')], QueryBuilder.prototype, "sortDirection", void 0);

    __decorate([sf.base.Property(5)], QueryBuilder.prototype, "maxGroupCount", void 0);

    __decorate([sf.base.Property('auto')], QueryBuilder.prototype, "height", void 0);

    __decorate([sf.base.Property('auto')], QueryBuilder.prototype, "width", void 0);

    __decorate([sf.base.Property(false)], QueryBuilder.prototype, "matchCase", void 0);

    __decorate([sf.base.Property(0)], QueryBuilder.prototype, "immediateModeDelay", void 0);

    __decorate([sf.base.Property(false)], QueryBuilder.prototype, "enableNotCondition", void 0);

    __decorate([sf.base.Property(false)], QueryBuilder.prototype, "readonly", void 0);

    __decorate([sf.base.Complex({
      condition: 'and',
      rules: []
    }, Rule)], QueryBuilder.prototype, "rule", void 0);

    QueryBuilder = __decorate([sf.base.NotifyPropertyChanges], QueryBuilder);
    return QueryBuilder;
  }(sf.base.Component);
  /**
...
sfBlazor.modules["querybuilder"] = "querybuilder.QueryBuilder";
sfBlazor.loadDependencies(sfBlazor.dependencyJson.querybuilder, function () {
  sf.querybuilder = sf.base.extend({}, sf.querybuilder, sfquerybuilder({}));
});
