(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["navigationsbase"],{
...
var navigationsbase = function navigationsbase(exports) {
  ...
  function (_super) {
    ...
    __decorate$2([sf.base.Property('id')], FieldSettings.prototype, "itemId", void 0);

    __decorate$2([sf.base.Property('parentId')], FieldSettings.prototype, "parentId", void 0);

    __decorate$2([sf.base.Property('text')], FieldSettings.prototype, "text", void 0);

    __decorate$2([sf.base.Property('iconCss')], FieldSettings.prototype, "iconCss", void 0);

    __decorate$2([sf.base.Property('url')], FieldSettings.prototype, "url", void 0);

    __decorate$2([sf.base.Property('separator')], FieldSettings.prototype, "separator", void 0);

    __decorate$2([sf.base.Property('items')], FieldSettings.prototype, "children", void 0);
  ...
  function (_super) {
    ...
    __decorate$2([sf.base.Property(null)], MenuItem.prototype, "iconCss", void 0);

    __decorate$2([sf.base.Property('')], MenuItem.prototype, "id", void 0);

    __decorate$2([sf.base.Property(false)], MenuItem.prototype, "separator", void 0);

    __decorate$2([sf.base.Collection([], MenuItem)], MenuItem.prototype, "items", void 0);

    __decorate$2([sf.base.Property('')], MenuItem.prototype, "text", void 0);

    __decorate$2([sf.base.Property('')], MenuItem.prototype, "url", void 0);
  ...
  function (_super) {
    ...
    __decorate$2([sf.base.Property('SlideDown')], MenuAnimationSettings.prototype, "effect", void 0);

    __decorate$2([sf.base.Property(400)], MenuAnimationSettings.prototype, "duration", void 0);

    __decorate$2([sf.base.Property('ease')], MenuAnimationSettings.prototype, "easing", void 0);
  ...
  function (_super) {
    ...
    MenuBase.prototype.closeMenu = function (ulIndex, e) {
      ...
      if (this.isMenuVisible()) {
        ...
        ul_1 = this.isMenu && cnt !== 1 ? sf.base.select('.e-ul', popups[cnt - 2]) : sf.base.selectAll('.e-menu-parent', wrapper)[cnt - 1];
        ...
        if (!isClose) {
          ...
          beforeCloseArgs = {
            element: ul_1,
            parentItem: this.isMenu && sf.base.isBlazor() ? this.getMenuItemModel(item_1, ulIndex) : item_1,
            items: items_1,
            event: e,
            cancel: false
          };
          this.trigger('beforeClose', beforeCloseArgs, function (observedCloseArgs) {
            ...
            if (isOpen || _this.isCMenu) {
              if (_this.isMenu) {
                ...
                _this.destroyScrollObj(sf.base.getInstance(popupEle.children[0], VScroll), popupEle.children[0]);
    ...
    MenuBase.prototype.destroyScrollObj = function (scrollObj, scrollEle) {
      if (scrollObj) {
        scrollObj.destroy();
        scrollEle.parentElement.appendChild(sf.base.select('.e-menu-parent', scrollEle));
        sf.base.detach(scrollEle);
      }
    };
    ...
    MenuBase.prototype.triggerBeforeOpen = function (li, ul, item, e, top, left, type) {
      ...
      var eventArgs = {
        element: ul,
        items: items,
        parentItem: this.isMenu && sf.base.isBlazor() ? this.getMenuItemModel(item, this.navIdx.length - 1) : item,
        event: e,
        cancel: false,
        top: top,
        left: left
          ...
          case 'menu':
            ...
            if (!_this.hamburgerMode && !_this.left && !_this.top) {
              ...
              if ((_this.isNestedOrVertical || _this.enableRtl) && (collide.indexOf('right') > -1 || collide.indexOf('left') > -1)) {
                ...
                _this.left = _this.enableRtl ? sf.popups.calculatePosition(_this.lItem, _this.isNestedOrVertical ? 'right' : 'left', 'top').left : _this.left - _this.popupWrapper.offsetWidth - offWidth + 2;
              }
    ...
    MenuBase.prototype.addScrolling = function (wrapper, ul, scrollType, wrapperOffset, contentOffset) {
      if (this.enableScrolling && wrapperOffset < contentOffset) {
        ...
        if (scrollType === 'vscroll') {
          ...
          scrollObj.scrollStep = sf.base.select('.e-' + scrollType + '-bar', wrapper).offsetHeight / 2;
        } else {
          scrollObj = new HScroll({
            enableRtl: this.enableRtl
          }, scrollEle);
          scrollObj.scrollStep = sf.base.select('.e-' + scrollType + '-bar', wrapper).offsetWidth;
        }
      }
    };
    ...
    MenuBase.prototype.createItems = function (items) {
      ...
      var ul = sf.lists.ListBase.createList(this.createElement, items, listBaseOptions, !this.template);
    ...
    MenuBase.prototype.moverHandler = function (e) {
      ...
      if (this.isMenu) {
        if (!this.showItemOnClick && trgt.parentElement !== wrapper && !sf.base.closest(trgt, '.e-' + this.getModuleName() + '-popup') && (!cli || cli && !this.getIndex(cli.id, true).length)) {
        ...
        switch (prop) {
          ...
          case 'enableScrolling':
            if (newProp.enableScrolling) {
              ...
              this_1.element.classList.contains('e-vertical') ? this_1.destroyScrollObj(sf.base.getInstance(ul_3, VScroll), ul_3) : this_1.destroyScrollObj(sf.base.getInstance(ul_3, HScroll), ul_3);
              wrapper.style.overflow = '';
              wrapper.appendChild(this_1.element);
              this_1.getPopups().forEach(function (wrapper) {
                ul_3 = wrapper.children[0];

                _this.destroyScrollObj(sf.base.getInstance(ul_3, VScroll), ul_3);
    ...
    __decorate$2([sf.base.Event()], MenuBase.prototype, "beforeItemRender", void 0);

    __decorate$2([sf.base.Event()], MenuBase.prototype, "beforeOpen", void 0);

    __decorate$2([sf.base.Event()], MenuBase.prototype, "onOpen", void 0);

    __decorate$2([sf.base.Event()], MenuBase.prototype, "beforeClose", void 0);

    __decorate$2([sf.base.Event()], MenuBase.prototype, "onClose", void 0);

    __decorate$2([sf.base.Event()], MenuBase.prototype, "select", void 0);

    __decorate$2([sf.base.Event()], MenuBase.prototype, "created", void 0);

    __decorate$2([sf.base.Property('')], MenuBase.prototype, "cssClass", void 0);

    __decorate$2([sf.base.Property(false)], MenuBase.prototype, "showItemOnClick", void 0);

    __decorate$2([sf.base.Property('')], MenuBase.prototype, "target", void 0);

    __decorate$2([sf.base.Property('')], MenuBase.prototype, "filter", void 0);

    __decorate$2([sf.base.Property(null)], MenuBase.prototype, "template", void 0);

    __decorate$2([sf.base.Property(false)], MenuBase.prototype, "enableScrolling", void 0);

    __decorate$2([sf.base.Property(false)], MenuBase.prototype, "enableHtmlSanitizer", void 0);
    ...
    __decorate$2([sf.base.Collection([], MenuItem)], MenuBase.prototype, "items", void 0);
    ...
    MenuBase = __decorate$2([sf.base.NotifyPropertyChanges], MenuBase);
    return MenuBase;
  }(sf.base.Component);
  ...
  exports.MenuAnimationSettings = MenuAnimationSettings;
  exports.MenuBase = MenuBase;
  return exports;
};

sfBlazor.modules["navigationsbase"] = "navigations.HScroll";
