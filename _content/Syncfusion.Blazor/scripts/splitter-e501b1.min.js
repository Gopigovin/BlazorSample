(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["splitter"],{
...
/* harmony import */ var _modules_splitter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/splitter.js */ "./modules/splitter.js");
...
var sfsplitter = function sfsplitter(exports) {
  'use strict';
  ...
  function (_super) {
    ...
    __decorate([sf.base.Property()], PaneProperties.prototype, "size", void 0);

    __decorate([sf.base.Property(false)], PaneProperties.prototype, "collapsible", void 0);

    __decorate([sf.base.Property(false)], PaneProperties.prototype, "collapsed", void 0);

    __decorate([sf.base.Property(true)], PaneProperties.prototype, "resizable", void 0);

    __decorate([sf.base.Property(null)], PaneProperties.prototype, "min", void 0);

    __decorate([sf.base.Property(null)], PaneProperties.prototype, "max", void 0);

    __decorate([sf.base.Property()], PaneProperties.prototype, "content", void 0);

    __decorate([sf.base.Property('')], PaneProperties.prototype, "cssClass", void 0);
  ...
  function (_super) {
    ...
    Splitter.prototype.updatePaneSize = function (newValSize, index) {
      ...
      for (var i = 0; i < this.allPanes.length; i++) {
        if (!this.paneSettings[i].size && !(this.allPanes[i].innerText === '')) {
          ...
          staticPaneWidth = this.paneSettings[i].size && this.paneSettings[i].size.indexOf('%') > -1 ? parseInt(newValSize, 10) / 100 * this.element.offsetWidth : this.allPanes[index].offsetWidth;
        }
      }
    ...
    Splitter.prototype.setSplitterSize = function (element, size, property) {
      var style = property === 'width' ? {
        'width': sf.base.formatUnit(size)
      } : {
        'height': sf.base.formatUnit(size)
      };
      ...
      for (var i = 0; i < childCount; i++) {
        if (i < childCount - 1) {
          if (!this.checkBlazor()) {
            ...
            sf.base.setStyleAttribute(separator, {
              'order': i * 2 + 1
            });
    ...
    Splitter.prototype.isResizable = function () {
      ...
      if (!sf.base.isNullOrUndefined(this.paneSettings[this.getPreviousPaneIndex()]) && this.paneSettings[this.getPreviousPaneIndex()].resizable && !sf.base.isNullOrUndefined(this.paneSettings[this.getNextPaneIndex()]) && this.paneSettings[this.getNextPaneIndex()].resizable || sf.base.isNullOrUndefined(this.paneSettings[this.getNextPaneIndex()])) {
        resizable = true;
      }
    ...
    Splitter.prototype.panesDimension = function (index, child) {
      ...
      if (!sf.base.isNullOrUndefined(this.paneSettings[index])) {
        if (!sf.base.isNullOrUndefined(this.paneSettings[index].size)) {
          ...
          if (index < childCount) {
            sf.base.setStyleAttribute(child[index], {
              'flex-basis': size,
              'order': index * 2
            });
    ...
    Splitter.prototype.addPaneClass = function (pane) {
      this.orientation === 'Horizontal' ? sf.base.addClass([pane], [PANE, SPLIT_H_PANE, SCROLL_PANE]) : sf.base.addClass([pane], [PANE, SPLIT_V_PANE, SCROLL_PANE]);
      return pane;
    };
    ...
    __decorate([sf.base.Property('100%')], Splitter.prototype, "height", void 0);

    __decorate([sf.base.Property('100%')], Splitter.prototype, "width", void 0);

    __decorate([sf.base.Collection([], PaneProperties)], Splitter.prototype, "paneSettings", void 0);

    __decorate([sf.base.Property('Horizontal')], Splitter.prototype, "orientation", void 0);

    __decorate([sf.base.Property('')], Splitter.prototype, "cssClass", void 0);

    __decorate([sf.base.Property(true)], Splitter.prototype, "enabled", void 0);

    __decorate([sf.base.Property(true)], Splitter.prototype, "enableHtmlSanitizer", void 0);

    __decorate([sf.base.Property(null)], Splitter.prototype, "separatorSize", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "beforeSanitizeHtml", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "created", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "resizeStart", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "resizing", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "resizeStop", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "beforeCollapse", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "beforeExpand", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "collapsed", void 0);

    __decorate([sf.base.Event()], Splitter.prototype, "expanded", void 0);

    Splitter = __decorate([sf.base.NotifyPropertyChanges], Splitter);
    return Splitter;
  }(sf.base.Component);
  /**
   * splitter modules
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.splitter, function () {
