(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboardlayout"],{

/***/ "./bundles/dashboardlayout.js":
/*!************************************!*\
  !*** ./bundles/dashboardlayout.js ***!
  \************************************/
/*! no exports provided */
...
/* harmony import */ var _modules_dashboardlayout_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/dashboardlayout.js */ "./modules/dashboardlayout.js");


/***/ }),

/***/ "./modules/dashboardlayout.js":
/*!************************************!*\
  !*** ./modules/dashboardlayout.js ***!
  \************************************/
/*! no exports provided */
...
var sfdashboardlayout = function sfdashboardlayout(exports) {
  'use strict';
  ...
  function (_super) {
    ...
    __decorate([sf.base.Property('')], Panel.prototype, "id", void 0);

    __decorate([sf.base.Property('')], Panel.prototype, "cssClass", void 0);

    __decorate([sf.base.Property('')], Panel.prototype, "header", void 0);

    __decorate([sf.base.Property('')], Panel.prototype, "content", void 0);

    __decorate([sf.base.Property(true)], Panel.prototype, "enabled", void 0);

    __decorate([sf.base.Property(0)], Panel.prototype, "row", void 0);

    __decorate([sf.base.Property(0)], Panel.prototype, "col", void 0);

    __decorate([sf.base.Property(1)], Panel.prototype, "sizeX", void 0);

    __decorate([sf.base.Property(1)], Panel.prototype, "sizeY", void 0);

    __decorate([sf.base.Property(1)], Panel.prototype, "minSizeY", void 0);

    __decorate([sf.base.Property(1)], Panel.prototype, "minSizeX", void 0);

    __decorate([sf.base.Property(null)], Panel.prototype, "maxSizeY", void 0);

    __decorate([sf.base.Property(null)], Panel.prototype, "maxSizeX", void 0);

    __decorate([sf.base.Property(1000)], Panel.prototype, "zIndex", void 0);
  ...
  function (_super) {
    ...
    DashboardLayout.prototype.renderPanels = function (cellElement, panelModel, panelId, isStringTemplate) {
      ...
      if (panelModel.content) {
        ...
        sf.base.setStyleAttribute(this.panelBody, {
    ...
    DashboardLayout.prototype.checkMediaQuerySizing = function () {
      ...
      for (var i = 0; i < updatedPanel.length; i++) {
        ...
        if (panelElement) {
          sf.base.setStyleAttribute(panelElement, {
            'width': '100%'
          });
          var layoutChangedArgs = {
            isHeightChange: isHeightChange
          };
          this.trigger('layoutChange', layoutChangedArgs);

          if (layoutChangedArgs.isHeightChange) {
    ...
    DashboardLayout.prototype.setHeightAndWidth = function (panelElement, panelModel) {
      sf.base.setStyleAttribute(panelElement, {
        'height': sf.base.formatUnit(this.setXYDimensions(panelModel)[0])
      });
      sf.base.setStyleAttribute(panelElement, {
        'width': sf.base.formatUnit(this.setXYDimensions(panelModel)[1])
      });
    };
    ...
    DashboardLayout.prototype.renderCell = function (panel, isStringTemplate, index) {
      ...
      if (!this.isBlazor) {
        ...
        if (bodyElement) {
          ...
          var contentHeightValue = 'calc( 100% - ' + headerHeight + ')';
          sf.base.setStyleAttribute(bodyElement, {
            height: contentHeightValue
          });
        }
      }
    ...
    DashboardLayout.prototype.sortCollisionItems = function (collisionItems) {
      ...
      var _loop_3 = function _loop_3(row) {
        rowElements = [];
        ...
        var _loop_4 = function _loop_4(column) {
    ...
    DashboardLayout.prototype.collisionPanel = function (collisionModels, colValue, updatedRow, clone) {
      ...
      if (collisionModels.length > 0) {
        ...
        if (this.overlapSubElementClone.length > 0) {
          var _loop_5 = function _loop_5(p) {
    ...
    DashboardLayout.prototype.checkForChanges = function (isInteracted, added, removed) {
      ...
      if (this.removeAllCalled) {
        ...
        for (var i = 0; i < this.panels.length; i++) {
          if ((!sf.base.isNullOrUndefined(added) ? this.panels[i].id !== added[0].id : true) && (!sf.base.isNullOrUndefined(removed) ? this.panels[i].id !== removed[0].id : true) && (this.panels[i].row !== this.panelsInitialModel[i].row || this.panels[i].col !== this.panelsInitialModel[i].col)) {
      ...
      if (changedPanels.length > 0 || this.removeAllCalled) {
        var changedArgs = {
          ...
          addedPanels: !sf.base.isNullOrUndefined(added) ? added : [],
          removedPanels: !sf.base.isNullOrUndefined(removed) ? removed : []
        };
    ...
    DashboardLayout.prototype.mergePersistPanelData = function (persistedData) {
      ...
      if (!(sf.base.isNullOrUndefined(data) || data === '') || !sf.base.isNullOrUndefined(persistedData)) {
        ...
        for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
          ...
          if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(sf.base.getValue(key, this)) === 'object' && !sf.base.isNullOrUndefined(sf.base.getValue(key, this))) {
    ...
    __decorate([sf.base.Property(true)], DashboardLayout.prototype, "allowDragging", void 0);

    __decorate([sf.base.Property(false)], DashboardLayout.prototype, "allowResizing", void 0);

    __decorate([sf.base.Property(true)], DashboardLayout.prototype, "allowPushing", void 0);

    __decorate([sf.base.Property(true)], DashboardLayout.prototype, "enableHtmlSanitizer", void 0);

    __decorate([sf.base.Property(true)], DashboardLayout.prototype, "allowFloating", void 0);

    __decorate([sf.base.Property(1)], DashboardLayout.prototype, "cellAspectRatio", void 0);

    __decorate([sf.base.Property([5, 5])], DashboardLayout.prototype, "cellSpacing", void 0);

    __decorate([sf.base.Property(1)], DashboardLayout.prototype, "columns", void 0);

    __decorate([sf.base.Property(false)], DashboardLayout.prototype, "showGridLines", void 0);

    __decorate([sf.base.Property(null)], DashboardLayout.prototype, "draggableHandle", void 0);

    __decorate([sf.base.Property('en-US')], DashboardLayout.prototype, "locale", void 0);

    __decorate([sf.base.Property('max-width: 600px')], DashboardLayout.prototype, "mediaQuery", void 0);

    __decorate([sf.base.Collection([], Panel)], DashboardLayout.prototype, "panels", void 0);

    __decorate([sf.base.Property(['e-south-east'])], DashboardLayout.prototype, "resizableHandles", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "change", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "layoutChange", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "dragStart", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "drag", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "dragStop", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "resizeStart", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "resize", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "resizeStop", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "created", void 0);

    __decorate([sf.base.Event()], DashboardLayout.prototype, "destroyed", void 0);

    DashboardLayout = __decorate([sf.base.NotifyPropertyChanges], DashboardLayout);
    return DashboardLayout;
  }(sf.base.Component);
  /**
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.dashboardlayout, function () {
